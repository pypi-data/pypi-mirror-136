...
class CPVCSMergeManager(SubtypesInstanceManager):
 @nspko
 def _is_special_case(obj)->nspkF:
  return nspkc(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:nspkr,to_state_files):
  raise nspkl("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:nspkr,from_state_files:nspkr,to_state_files:nspkr):
  raise nspkl("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:nspkr)->Dict[nspkr,nspkr]:
