...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=lWcJG
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:lWcJt)->lWcJt:
  pass
 @lWcJf
 def get(cls,requested_file_locator:lWcJt):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=lWcJG
 @lWcJf
 def get(cls,state_file_locator:lWcJt,requested_storage:lWcJt,serializers:Dict[lWcJt,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[lWcJt,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:lWcJt)->lWcJt:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:lWcJt)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:lWcJt)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:lWcJt)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:lWcJt)->lWcJt:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[lWcJt]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:lWcJt,new_key:lWcJt,referenced_by_version:lWcJt=lWcJG):
  pass
 @abc.abstractmethod
 def version_exists(self,key:lWcJt)->lWcJe:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:lWcJt,key:lWcJt):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:lWcJt,new_key:lWcJt,base_path:lWcJt)->lWcJe:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[lWcJt]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[lWcJt,lWcJt],remote_location:lWcJt=lWcJG)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[lWcJt]:
  ...
  for cpvcs_obj in args:
   if lWcJb(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif lWcJb(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[lWcJt,lWcJt],remote_location:lWcJt=lWcJG)->List[Union[Revision,Version]]:
