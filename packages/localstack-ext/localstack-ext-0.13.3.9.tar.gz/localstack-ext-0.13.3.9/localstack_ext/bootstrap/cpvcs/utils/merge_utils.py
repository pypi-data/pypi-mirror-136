...
class CPVCSMergeManager(SubtypesInstanceManager):
 @MGzYL
 def _is_special_case(obj)->MGzYn:
  return MGzYy(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:MGzYC,to_state_files):
  raise MGzYD("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:MGzYC,from_state_files:MGzYC,to_state_files:MGzYC):
  raise MGzYD("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:MGzYC)->Dict[MGzYC,MGzYC]:
