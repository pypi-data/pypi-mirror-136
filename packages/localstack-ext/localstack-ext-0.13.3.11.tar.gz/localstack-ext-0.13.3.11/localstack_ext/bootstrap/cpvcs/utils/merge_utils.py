...
class CPVCSMergeManager(SubtypesInstanceManager):
 @RXywe
 def _is_special_case(obj)->RXywD:
  return RXywb(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:RXywA,to_state_files):
  raise RXywB("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:RXywA,from_state_files:RXywA,to_state_files:RXywA):
  raise RXywB("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:RXywA)->Dict[RXywA,RXywA]:
