...
class RDSDBSubnetGroup(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=hicVo,**kwargs):
...
class RDSDBCluster(GenericBaseModel):
 ...
 @hicVt
 def add_defaults(resource:Dict,stack_name:hicVd):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return hicVe(RDSDBCluster,self).get_cfn_attribute(attribute)
 @hicVt
 def get_deploy_templates():
  ...
  def _params(params,**kwargs):
   ...
   return params
  result={"create":{"function":"create_db_cluster","parameters":_params,"types":{"Port":hicVv}},"delete":{"function":"delete_db_cluster","parameters":["DBClusterIdentifier"]}}
  return result
...
class RDSDBInstance(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return hicVe(RDSDBInstance,self).get_cfn_attribute(attribute)
 def fetch_state(self,stack_name,resources):
 ...
 def get_deploy_templates():
  ...
  return{"create":{"function":"create_db_instance","parameters":attrs+[{"VpcSecurityGroupIds":"VPCSecurityGroups"}],"types":{"AllocatedStorage":hicVv,"Port":hicVv}},"delete":{"function":"delete_db_instance","parameters":["DBInstanceIdentifier"]}}
