...
class CPVCSMergeManager(SubtypesInstanceManager):
 @VjWLO
 def _is_special_case(obj)->VjWLa:
  return VjWLn(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:VjWLB,to_state_files):
  raise VjWLH("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:VjWLB,from_state_files:VjWLB,to_state_files:VjWLB):
  raise VjWLH("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:VjWLB)->Dict[VjWLB,VjWLB]:
