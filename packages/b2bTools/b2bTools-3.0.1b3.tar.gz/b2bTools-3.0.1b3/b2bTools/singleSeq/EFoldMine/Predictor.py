...
class EFoldMine(B2bIo):
  ...
  def predictSeqs(self,seqs,dynaMinePreds=None, includeDiscreteClass=False):
    ...
    for (seqId,sequence) in seqs:
      ...
      self.model.__dict__['_n_support'] = self.model.__dict__['n_support_'].astype(np.int32)
      self.model.__dict__['_probA'] = self.model.__dict__['probA_']
      self.model.__dict__['_probB'] = self.model.__dict__['probB_']
      self.model.__dict__['support_'] = self.model.__dict__['support_'].astype(np.int32)
