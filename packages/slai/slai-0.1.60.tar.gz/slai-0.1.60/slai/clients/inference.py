...
def _get_model_info(base_url, client_id, client_secret, model_id, model_version_id=None):
...
class ModelInferenceClient:
    ...
    def call(self, payload):
        ...
        try:
            result = ModelTypes.deserialize(response_data["result"]["result"], output_schema)
        except (InvalidTypeException, InvalidPayloadException) as e:
            print(e, e.errors)
            return None
