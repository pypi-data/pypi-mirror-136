...
class ModelInferenceClient:
    ...
    def call(self, payload):
        if self.model_info is None:
            self.model_info = _get_model_info(
        ...
        input_schema = ModelTypes.load_schema(self.model_info["input_schema"])
        output_schema = ModelTypes.load_schema(self.model_info["output_schema"])
