...
class CfnGlobalTable(
    ...
    def __init__(
        ...
        *,
        ...
        :param time_to_live_specification: Specifies the Time to Live (TTL) settings for the table. This setting will be applied to all replicas. .. epigraph:: For detailed information about the TTL feature of DynamoDB, see `Expiring Items with Time to Live <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/TTL.html>`_ in the Amazon DynamoDB Developer Guide.
    ...
    def time_to_live_specification(
        ...
        .. epigraph::
           ...
           For detailed information about the TTL feature of DynamoDB, see `Expiring Items with Time to Live <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/TTL.html>`_ in the Amazon DynamoDB Developer Guide.
...
class CfnTable(
    ...
    def __init__(
        ...
        *,
        ...
        :param time_to_live_specification: Specifies the Time to Live (TTL) settings for the table. .. epigraph:: For detailed information about the TTL feature of DynamoDB, see `Expiring Items with Time to Live <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/TTL.html>`_ in the Amazon DynamoDB Developer Guide.
        '''
        props = CfnTableProps(
            key_schema=key_schema,
            attribute_definitions=attribute_definitions,
