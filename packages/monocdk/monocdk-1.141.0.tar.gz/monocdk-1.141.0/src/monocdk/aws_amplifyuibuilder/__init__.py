...
class CfnComponent(
    ...
    def __init__(
        ...
        *,
        ...
        overrides: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Mapping[builtins.str, typing.Any]]] = None,
    ...
    def overrides(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Mapping[builtins.str, typing.Any]]], jsii.get(self, "overrides"))
