...
from data_repo_client.models.snapshot_request_access_include_model import SnapshotRequestAccessIncludeModel  # noqa: E501
from data_repo_client.rest import ApiException

class TestSnapshotRequestAccessIncludeModel(unittest.TestCase):
    """SnapshotRequestAccessIncludeModel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SnapshotRequestAccessIncludeModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = data_repo_client.models.snapshot_request_access_include_model.SnapshotRequestAccessIncludeModel()  # noqa: E501
        if include_optional :
            return SnapshotRequestAccessIncludeModel(
            )
        else :
            return SnapshotRequestAccessIncludeModel(
        )

    def testSnapshotRequestAccessIncludeModel(self):
        """Test SnapshotRequestAccessIncludeModel"""
