...
####
        ...
        self.amplitude_min_intensity = 1.0
        self.amplitude_total_intensity = 1.0
        self.elements = ''
        self.z_height = ''
        self.elements_count = []
        self.atom_energy = 0.0
####
    ...
    # def structure_element(self):
     #   """ the elements that should be in this atom position """
...
####
        if (mask_radius is None) and (percent_to_nn is None):
            ...
            data_slice_max = image_data[mask].max()
...
####
    ...
    def calculate_mean_intensity(
            ...
            percent_to_nn=0.40,
            mask_radius=None):
        """Find the mean intensity of the atom.

        The mean is found within the the distance to the nearest
        neighbor times percent_to_nn.
        """
####
        if (mask_radius is None) and (percent_to_nn is None):
            ...
            data_slice_mean = image_data[mask].mean()

####
        self.amplitude_mean_intensity = data_slice_mean

        return(data_slice_mean)
...
####
        if (mask_radius is None) and (percent_to_nn is None):
            ...
            data_slice_min = image_data[mask].min()
