...
def get_items(client: Client, list_: Optional[List[Dict[str, Any]]], cat_id: int) -> Dict[int, Client.Product]:
    if list_ is None:
        return {}
...
class Client:
    ...
    class Product(Product):
        def __init__(self, client: Client, id: Optional[int] = None, data: Optional[Dict[str, Any]] = None, cat_id: Optional[int] = None) -> None:
            self.__client = client
