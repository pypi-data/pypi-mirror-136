...
def draw_text(image, text, rgb, font_size, bot_right, center_text=False):
    font_dir = fr"{os.path.dirname(os.path.realpath(__file__))}\\Resources\Layout\Pixellari.ttf"
...
def draw_portrait(
    ...
    # loads images
    input_file = fr"{os.path.dirname(os.path.realpath(__file__))}/Resources/Layout/char_portrait_no_nick.png"
    ...
    if character:
        char_dir = fr"{os.path.dirname(os.path.realpath(__file__))}\\resources\characters\Main"
...
def draw_results(
    ...
    input_file = fr"{os.path.dirname(os.path.realpath(__file__))}\\Resources\Backgrounds\{stage}\{stage_variant}.png"
