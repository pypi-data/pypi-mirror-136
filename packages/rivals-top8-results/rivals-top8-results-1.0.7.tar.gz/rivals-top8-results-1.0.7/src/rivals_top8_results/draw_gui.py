...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        stages_dir = fr"{os.path.dirname(os.path.realpath(__file__))}\\resources\\Backgrounds\\"
    ...
    def load_results(self, json_file=fr"{os.path.dirname(os.path.realpath(__file__))}\\resources\\bracket.json"):
    ...
    def save_and_gen_results(self):
        ...
        with open(fr"{os.path.dirname(os.path.realpath(__file__))}\\resources\\bracket.json") as top8_file:
            top8 = json.load(top8_file)
...
def generate_from_json(bracket):
    logo = Image.open(fr"{os.path.dirname(os.path.realpath(__file__))}\\Resources\Layout\logo.png")
    logo = logo.resize(
