...
from cognite.airworkflow.constants import CHANGED_CODE_SCRIPT_PATH, REPO_CONFIG, REPO_CONFIG_PROJECT_FUNCTION_MAP
...
def final_string_generator():
    ...
    for i in valuesYaml[REPO_CONFIG_PROJECT_FUNCTION_MAP]:
        tenant_name_list = valuesYaml[REPO_CONFIG_PROJECT_FUNCTION_MAP][i]
