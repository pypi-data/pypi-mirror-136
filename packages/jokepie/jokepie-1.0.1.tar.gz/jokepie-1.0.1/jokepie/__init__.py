...
class Client:
	...
	def get_joke(self, content='', lang='english', categories: list=['any'], blacklist=[], joke_type='single', safe_mode=False, id_range=[], amount: int = 1):
	...
	def upload_joke(self, joke, category, joke_type='single', lang='english', on_flags=[]):
