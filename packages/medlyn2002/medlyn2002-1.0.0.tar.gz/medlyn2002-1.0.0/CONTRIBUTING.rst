...
**medlyn2002** could always use more documentation, whether as
part of the official **medlyn2002** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `medlyn2002` for local
development.

1. Fork the `medlyn2002` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/medlyn2002.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd medlyn2002
    (dvlpt) medlyn2002$ flake8
    (dvlpt) medlyn2002$ pytest
    
    (dvlpt) medlyn2002$ tox
...
.. _issues: https://gitlab.com/b326/medlyn2002/issues
