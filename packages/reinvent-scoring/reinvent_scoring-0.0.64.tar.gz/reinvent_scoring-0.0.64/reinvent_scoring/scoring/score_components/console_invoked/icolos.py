...
class Icolos(BaseConsoleInvokedComponent):
    def __init__(self, parameters: ComponentParameters):
        ...
        self._executor_script_path = self.parameters.specific_parameters[self.component_specific_parameters.ICOLOS_EXECUTORSCRIPTPATH]
        self._environment_path = self.parameters.specific_parameters[self.component_specific_parameters.ICOLOS_ENVPATH]
