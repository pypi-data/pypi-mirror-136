...
class RadiometricCalibDisplaySession(CalibrationSession, ABC):
    def __init__(self, camera, radio_calib, path='CalibrationImages/DisplayRadiometric', exposure=13000, numPhaseShift = 4, height = DISPLAY_HEIGHT, width = DISPLAY_WIDTH):
    ...
    def setDefPattern(self):
        ...
        for i in range(self.NumPatterns):
            self.patterns[..., i] = i * np.ones((self.displayHeight,self.displayWidth))
