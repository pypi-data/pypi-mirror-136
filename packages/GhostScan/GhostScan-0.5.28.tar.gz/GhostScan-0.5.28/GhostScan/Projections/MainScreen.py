...
class Screen(Projection, ABC):
    ...
    def displayCalibrationPattern(self, camera, path_calib='CalibrationImages/8_24_checker.png',
                                  save_img='CalibrationImages/Geometric'):
        self.camera = camera
        ...
        if os.path.exists('CalibrationImages'):
            os.mkdir('CalibrationImages/')
        if os.path.exists('CalibrationImages/Geometric'):
            os.mkdir('CalibrationImags/Geometric/')
