...
from helios.pika_instrumentation import utils
from helios.pika_instrumentation.package import _instruments
from helios.pika_instrumentation.version import __version__
from opentelemetry.instrumentation.utils import unwrap
from opentelemetry.trace import Tracer, TracerProvider

_LOG = getLogger('opentelemetry.instrumentation.pika.pika_instrumentor')
...
class PikaInstrumentor(BaseInstrumentor):  # type: ignore
    ...
    def instrument_channel(
        ...
        if channel._is_instrumented_by_opentelemetry:
            ...
            return
        tracer = trace.get_tracer('opentelemetry.instrumentation.pika.pika_instrumentor', __version__, tracer_provider)
