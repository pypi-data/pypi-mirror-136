...
def get_allocation_stats():
    gzxj__xhib = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    tcprn__chdhl, yjei__vkia, kxgde__hsu, jvfoh__qxvze = 0, 0, 0, 0
    for ykrry__njyt in gzxj__xhib:
        tcprn__chdhl += ykrry__njyt[0]
        yjei__vkia += ykrry__njyt[1]
        kxgde__hsu += ykrry__njyt[2]
        jvfoh__qxvze += ykrry__njyt[3]
    return tcprn__chdhl, yjei__vkia, kxgde__hsu, jvfoh__qxvze
