...
from powerbot_backtesting.utils import _order_matching, _find_cache, _battery_order_matching_free, _battery_order_matching_linked
...
class BacktestingAlgo(BacktestingBase):
    ...
    def match_orders(self,
        ...
        """
        return _order_matching(side, orderbook, timestamp, price, position, self.exec_orders_list, self.trade_list[key] if key else self.trade_list,
    ...
    def run(self) -> Union[dict, bool]:
        ...
        for key, contract in self.orderbooks.items():
