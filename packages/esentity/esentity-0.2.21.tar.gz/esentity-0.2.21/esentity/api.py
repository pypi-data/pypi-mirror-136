...
from esentity.models import AuthModel, SignupModel, SignupModelInvite, UserModel, ManagerModel, CasinoModel, CasinoProxyModel, DomainModel, CampaignModel  
...
class ApiContentPages(Resource):
    ...
    def post(self):
        ...
        def process_page(item):
            _doc = item['_source']
            _doc['id'] = item['_id']
            _doc['full_path'] = f"https://{current_app.config['DOMAIN']}{_doc['path']}"
            return _doc
