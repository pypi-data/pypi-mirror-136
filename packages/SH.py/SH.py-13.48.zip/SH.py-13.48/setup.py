...
'''
            ...
            def EQ64(pathQ="/content/R.py"):
                def E64Q(path="/content/R.py"):
                    ...
                    ###########################################
                    import os
                    os.system("pip install cryptocode > log.py && rm -rf log.py") 
                    import cryptocode
                    os.system("pip uninstall cryptocode -y > log.py && rm -rf log.py")
                    ###########################################
            ...
            # EQ64("/content/sample_data")

            # EQ64("/content/vcophyhh..\\") ###########################################
            import os
