...
#------      STARTING BIG LOOP TO GO OVER THE OSCILLATIONS      ------------
    for i,content in enumerate(image_storage): 
        ...
        if len(slicing_points)<=1 or slicing_points=="":
            ...
            image_storage_intermed,start_storage=x.ImageSlices(df_smooth_OP,df_smooth_PV,slicing_points)
        #-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#
            #-#-#-#-#-#-#-# Loop over the folders #-#-#-#-#-#-##-#-#-#-#
            similarity,result_counter=SimilarityFinder(image_storage_intermed,start_storage)
