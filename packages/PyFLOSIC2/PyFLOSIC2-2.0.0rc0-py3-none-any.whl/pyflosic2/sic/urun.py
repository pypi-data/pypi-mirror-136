...
class URUN(UWORKFLOW):
    """
        The URUN class
        --------------
        Similar to UWORKFLOW, however the input contains now 
        both nuclei and initial FODs. Thus 

            atoms = nuclei + fod1 + fod2 
