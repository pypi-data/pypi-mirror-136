...
\refstepcounter{doconce:movie:counter}
\begin{center}
Taking images to animate from cyberspace. \Verb!https://hplgit.github.io/animate/doc/pub/mov-animate/frames/frame_%04d.png:80->129!: load \href{{file:///app/test/movie_player1.html}}{\nolinkurl{movie_player1.html}} into a browser
\end{center}
...
\begin{quote}
% link to web movie
Movie \arabic{doconce:movie:counter}:  \href{https://github.com/doconce/doconce_doc/blob/main/src/manual/mov/wave.ogg}{\nolinkurl{https://github.com/doconce/doconce_doc/blob/main/src/manual/mov/wave.ogg}}
\end{quote}
\end{doconce:movie}
