...
__copyright__ = "Copyright 2018-2022, Uwe Graichen"
...
class SpharaFilter(SpharaBasis):
    ...
    def specification(self, specification):
        if isinstance(specification, (int)):
            ...
            if specification.shape[0] != self._triangsamples.vertlist.shape[0]:
                raise IndexError("""The length of the specification vector
                does not match to the number of spatial sample points.""")
            else:
