...
class FragilityCurves:
    ...
    def plot(self, figure_size: tuple = (12, 8), include_mdf: bool = False) -> Figure:
        ...
        for i, ds in enumerate(self.damage_state_descriptions):
            ...
            ax.plot(self.intensity_measure_values, ys, lw=2, linestyle='-', label=f"DS{i + 1}")
...
def main():
    # fc = FragilityCurves(format='discrete',
    #                      typology='RC1',
    ...
    path = r'D:\mypythons\jupyters\phd\FragilityCurvesCollection\Martins2020\fragility_curves\fragility_other_IMs/'
    csv = "CR_LDUAL-DUH_H1.csv"

    fc = FragilityCurves.from_martins_silva_2020_csv(path=path,
                                                     csv_filename=csv)
    ...
    print(fc.mean_damage_factors_array)
