...
@dataclass(eq=False, repr=False)
class ValidateGeometryResponse(betterproto.Message):
    pois: List["GeometryValidations"] = betterproto.message_field(1)
...
@dataclass(eq=False, repr=False)
class GeometryValidations(betterproto.Message):
    name: str = betterproto.string_field(1)
    severity: str = betterproto.string_field(2)
...
class ByoServiceStub(betterproto.ServiceStub):
    ...
    async def validate_geometry(
        self, *, pois: Optional[List["PointOfInterest"]] = None
