...
class DimensionConsistency(betterproto.Enum):
    ALL_METRIC_PRESENT_IN_DIMENSION_AND_ALL_DIMENSION_PRESENT_IN_METRIC = 0
    ALL_METRIC_PRESENT_IN_DIMENSION = 1
...
class DimensionSpec(betterproto.Message):
    ...
    consistency: "DimensionConsistency" = betterproto.enum_field(7)
