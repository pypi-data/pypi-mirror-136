...
def bind_fastapi(court: Court, authorizer: Callable = None):
    """
    ...
    async def websocket(websocket: WebSocket, auth=Depends(authorizer)):
        ...
        async with client:
            tasks = [asyncio.create_task(websocket.receive_bytes()), asyncio.create_task(client.__anext__())]
            ...
            while True:
                ...
                if rcv_task in done:
                    ...
                    tasks[0] = asyncio.create_task(websocket.receive_bytes())
                ...
                if notif_task in done:
                    ...
                    if exc is not None:
                        ...
                        await websocket.send_bytes(record.payload)
