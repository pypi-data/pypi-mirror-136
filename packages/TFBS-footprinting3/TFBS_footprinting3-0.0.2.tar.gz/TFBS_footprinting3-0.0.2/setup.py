...
version = re.search(
    '^__version__\s*=\s*"(.*)"',
    open('tfbs_footprinter3/tfbs_footprinter3.py').read(),
    re.M
    ).group(1)
...
##    data_files = [("data", ['data/above_cutoff_scores_dict.10000000.0.001.json', 'data/pwms.json'])],
    ...
    entry_points={"console_scripts": ['tfbs_footprinter3 = tfbs_footprinter3.tfbs_footprinter3:main']},
##    entry_points={
##        'console_scripts': [
##            'sample=sample:main',
##        ],
