...
""",
                      libraries=["SFCGAL" if "SFCGAL_LIBNAME" not in os.environ
                                 else os.environ["SFCGAL_LIBNAME"]],
                      library_dirs=[] if "LIBPATH" not in os.environ
                      else os.environ["LIBPATH"].split(os.pathsep),
                      include_dirs=[] if "INCLUDE_PATH" not in os.environ
