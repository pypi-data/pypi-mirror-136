# Generated by Django 3.2 on 2021-11-22 14:09
...
def fix_field(model_cls, field_name):
    try:
        name = model_cls.__name__
        logger.info(f"Migrating {name}.{field_name}")
        records = records_with_tilde(model_cls, field_name)
        id_field_name = name.lower() + "_id"
        for r in records:
            fix_record(r, name, id_field_name, field_name)
    except Exception as e:
        logger.error(e)
