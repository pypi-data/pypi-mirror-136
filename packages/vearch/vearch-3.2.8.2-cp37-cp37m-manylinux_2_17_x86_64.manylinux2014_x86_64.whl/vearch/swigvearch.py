...
def swigSetNprobe(engine, nprobe, index_type):
    return _swigvearch.swigSetNprobe(engine, nprobe, index_type)

def swigSetRerank(engine, rerank, index_type):
    return _swigvearch.swigSetRerank(engine, rerank, index_type)

def swigCreateVectorResult(n, k, dists, labels):
    return _swigvearch.swigCreateVectorResult(n, k, dists, labels)

def swigDeleteVectorResult(result):
    return _swigvearch.swigDeleteVectorResult(result)
...
def swigSearchCPP2(engine, result):
    return _swigvearch.swigSearchCPP2(engine, result)
...
def swigAddOrUpdateDocsCPP2(engine, docs, data, results):
    return _swigvearch.swigAddOrUpdateDocsCPP2(engine, docs, data, results)
