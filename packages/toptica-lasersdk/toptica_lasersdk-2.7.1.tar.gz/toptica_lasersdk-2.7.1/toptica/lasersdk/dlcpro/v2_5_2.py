# Generated from 'v2_5_2.xml' on 2022-02-01 09:54:30.474290
...
class DlMotorCalibration:
    ...
    def set(self, fit_a: float, fit_b: float, fit_c: float, wavelength_min: float, wavelength_max: float) -> None:
        assert isinstance(fit_a, float), "expected type 'float' for parameter 'fit_a', got '{}'".format(type(fit_a))
        assert isinstance(fit_b, float), "expected type 'float' for parameter 'fit_b', got '{}'".format(type(fit_b))
        assert isinstance(fit_c, float), "expected type 'float' for parameter 'fit_c', got '{}'".format(type(fit_c))
        assert isinstance(wavelength_min, float), "expected type 'float' for parameter 'wavelength_min', got '{}'".format(type(wavelength_min))
        assert isinstance(wavelength_max, float), "expected type 'float' for parameter 'wavelength_max', got '{}'".format(type(wavelength_max))
...
class NloLaserHeadServos:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._uv_lens = NloLaserHeadServoPwm2(client, name + ':uv-lens')
    ...
    @property
    def uv_lens(self) -> 'NloLaserHeadServoPwm2':
...
class TcBoard:
    def __init__(self, client: Client, name: str) -> None:
        ...
        self._channel1b = TcChannel2(client, name + ':channel1b')
        self._channel2 = TcChannel2(client, name + ':channel2')
        self._channel2b = TcChannel2(client, name + ':channel2b')
