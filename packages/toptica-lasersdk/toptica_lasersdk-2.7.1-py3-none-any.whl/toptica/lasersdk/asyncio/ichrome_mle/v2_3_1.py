# Generated from 'v2_3_1.xml' on 2022-02-01 09:54:38.106775
...
class Laser:
    ...
    async def set_external100(self, power: float) -> None:
        assert isinstance(power, float), "expected type 'float' for parameter 'power', got '{}'".format(type(power))
...
class Beam:
    ...
    async def shiftpolar(self, radial: int, tangential: int) -> None:
        assert isinstance(radial, int), "expected type 'int' for parameter 'radial', got '{}'".format(type(radial))
        assert isinstance(tangential, int), "expected type 'int' for parameter 'tangential', got '{}'".format(type(tangential))
    ...
    async def shift(self, step_a: int, step_b: int) -> None:
        assert isinstance(step_a, int), "expected type 'int' for parameter 'step_a', got '{}'".format(type(step_a))
        assert isinstance(step_b, int), "expected type 'int' for parameter 'step_b', got '{}'".format(type(step_b))
    ...
    async def moveto(self, xposition: float, yposition: float) -> None:
        assert isinstance(xposition, float), "expected type 'float' for parameter 'xposition', got '{}'".format(type(xposition))
        assert isinstance(yposition, float), "expected type 'float' for parameter 'yposition', got '{}'".format(type(yposition))
    ...
    async def sethome(self, use_current_settings: bool) -> None:
        assert isinstance(use_current_settings, bool), "expected type 'bool' for parameter 'use_current_settings', got '{}'".format(type(use_current_settings))
...
class Elliptec:
    ...
    async def move(self, time: int) -> None:
        assert isinstance(time, int), "expected type 'int' for parameter 'time', got '{}'".format(type(time))
    ...
    async def run(self, frequency: int) -> int:
        assert isinstance(frequency, int), "expected type 'int' for parameter 'frequency', got '{}'".format(type(frequency))
...
class Ibeam:
    ...
    async def cmd(self, cmd_string: str) -> None:
        assert isinstance(cmd_string, str), "expected type 'str' for parameter 'cmd_string', got '{}'".format(type(cmd_string))
...
class Rect:
    ...
    async def set(self, left: int, top: int, width: int, height: int) -> None:
        assert isinstance(left, int), "expected type 'int' for 'left', got '{}'".format(type(left))
        assert isinstance(top, int), "expected type 'int' for 'top', got '{}'".format(type(top))
        assert isinstance(width, int), "expected type 'int' for 'width', got '{}'".format(type(width))
        assert isinstance(height, int), "expected type 'int' for 'height', got '{}'".format(type(height))
...
class Script:
    ...
    async def store(self, newtxt: str) -> None:
        assert isinstance(newtxt, str), "expected type 'str' for parameter 'newtxt', got '{}'".format(type(newtxt))
