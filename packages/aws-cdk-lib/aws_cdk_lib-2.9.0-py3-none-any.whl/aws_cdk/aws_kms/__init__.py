...
class CfnAlias(
    ...
    .. epigraph::
       ...
       Adding, deleting, or updating an alias can allow or deny permission to the KMS key. For details, see `Using ABAC in AWS KMS <https://docs.aws.amazon.com/kms/latest/developerguide/abac.html>`_ in the *AWS Key Management Service Developer Guide* .
...
class CfnKey(
    ...
    def tags(self) -> _TagManager_0a598cb3:
        ...
        .. epigraph::
           ...
           Tagging or untagging a KMS key can allow or deny permission to the KMS key. For details, see `Using ABAC in AWS KMS <https://docs.aws.amazon.com/kms/latest/developerguide/abac.html>`_ in the *AWS Key Management Service Developer Guide* .
