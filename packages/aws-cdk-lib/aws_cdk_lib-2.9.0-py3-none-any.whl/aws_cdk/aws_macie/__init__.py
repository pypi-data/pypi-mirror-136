...
class CfnFindingsFilter(
    ...
    class CriterionProperty:
        def __init__(self) -> None:
            ...
            For more information, see `Criterion <https://docs.aws.amazon.com/macie/latest/APIReference/findingsfilters-id.html#findingsfilters-id-model-criterion>`_ in the *Amazon Macie API Reference* .
