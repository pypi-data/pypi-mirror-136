...
class CfnStateMachine(
    ...
    class DefinitionProperty:
        def __init__(self) -> None:
            ...
            State machine definitions adhere to the `Amazon States Language <https://docs.aws.amazon.com/step-functions/latest/dg/concepts-amazon-states-language.html>`_ . For example definition templates, see the `Definition format support <https://docs.aws.amazon.com/step-functions/latest/dg/development-options.html#development-options-format>`_ section of the *Development options* page in the Step Functions developer guide.
