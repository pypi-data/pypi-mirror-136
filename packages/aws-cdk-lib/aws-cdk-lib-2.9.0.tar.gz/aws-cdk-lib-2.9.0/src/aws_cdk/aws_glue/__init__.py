    ...
    class MongoDBTargetProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param connection_name: ``CfnCrawler.MongoDBTargetProperty.ConnectionName``.
            :param path: ``CfnCrawler.MongoDBTargetProperty.Path``.
    ...
    class S3TargetProperty:
        def __init__(
            ...
            *,
            ...
            :param sample_size: ``CfnCrawler.S3TargetProperty.SampleSize``.
    ...
    class TargetsProperty:
        def __init__(
            ...
            *,
            ...
            :param mongo_db_targets: ``CfnCrawler.TargetsProperty.MongoDBTargets``.
