...
class CfnConfigurationProfile(
    ...
    def __init__(
        ...
        *,
        ...
        :param type: The type of configurations that the configuration profile contains. A configuration can be a feature flag used for enabling or disabling new features or a freeform configuration used to introduce changes to your application.
