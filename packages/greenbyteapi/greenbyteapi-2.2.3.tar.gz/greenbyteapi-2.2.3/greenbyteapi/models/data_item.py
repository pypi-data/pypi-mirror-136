...
class DataItem(object):
    ...
    Attributes:
        ...
        data (dict<object, float>): A dictionary with timestamp as key and the
            data measurement as value. The timestamp is in the time zone
            configured in the Greenbyte Platform without UTC offset. Example:
