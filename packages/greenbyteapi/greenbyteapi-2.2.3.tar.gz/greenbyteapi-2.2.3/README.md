...
# What's new
## 2022-02-01 - New high resolution endpoint
A new [data endpoint](#/http/api-endpoints/data/get-high-res-data) has been added which allows you to fetch high resolution data for up to one hour in the past 12 hours.
