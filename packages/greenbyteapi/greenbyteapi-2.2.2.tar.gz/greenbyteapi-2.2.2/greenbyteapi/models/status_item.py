...
class StatusItem(object):
    ...
    Attributes:
        ...
        acknowledged (bool): Indicates whether the status has been
            acknowledged.
        component (Component): The status component categorization.
    ...
    def from_dictionary(cls,
        ...
        component = greenbyteapi.models.component.Component.from_dictionary(dictionary.get('component')) if dictionary.get('component') else None
