...
class ResourceStage:
    ...
    def run(self, output_path: str, start_block: int, max_error: int):
        ...
        self.aws_util.copy_to_redshift(redshift_table_name=f'crypto.ethereum.{self.redshift_table_name}',
                                       resource_s3_path=f's3://{self.aws_util.s3_bucket}/{s3_path}',
                                       max_error=max_error)
