...
class JobScheduler:
    ...
    def RepeatJob(self, startDT=None, func=None, args=(), kwargs={}, name=None, successCallback=None,
                  errorCallback=None, **k):
        '''
    ...
    def Find(self, **kwargs):
        return self.db.FindOne(Job, **kwargs)

    def FindAll(self, **kwargs):
        return self.db.FindAll(Job, **kwargs)
