...
def dielectric_constant(T = 298.15):
    ...
    """
    with open('core/dielectric_model_h2o.pickle', 'rb') as f:
        clf = pickle.load(f)
...
def F_calc(test_df, A_):
    binary_para = pd.read_excel("core/binary_parameters.xlsx")
    mixing_para = pd.read_excel("core/mixing_parameters.xlsx")
    b = 1.2
