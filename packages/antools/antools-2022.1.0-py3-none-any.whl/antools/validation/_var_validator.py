...
class VariableValidator():
    ...
    # TEXT TYPES
    def str(self, value:str, terminate:bool = True, max_len:int = None, min_len:int = None, 
    ...
    # NUMERIC TYPES
    def int(self, value:int, terminate:bool = True, max:int = None, min:int = None,
        ...
        if value in [0, 1] and not bool_allowed:
            ...
            self._log.error(msg, ValueError) if terminate else self._log.warning(msg)
            return False
    ...
    def float(self, value:float, terminate:bool = True, int_allowed:bool = True, max:int = None, min:int = None,
    ...
    def complex(self, value:complex, terminate:bool = True, none_allowed:bool = False):
    ...
    # SEQUENCE TYPES
    def list(self, value:list, terminate:bool = True, max_len:int = None, min_len:int = None,
    ...
    def tuple(self, value:tuple, terminate:bool = True, max_len:int = None, min_len:int = None,
            none_allowed:bool = False, forbidden:list = None, allowed:list = None) -> bool:
    ...
    def range(self, value:range, terminate:bool = True, none_allowed:bool = False):
    ...
    # MAPPING TYPES
    def dict(self, value:dict, terminate:bool = True, max_len:int = None, min_len:int = None,
    ...
    # SET TYPES
    def set(self, value:set, terminate:bool = True, max_len:int = None, min_len:int = None,
            none_allowed:bool = False, forbidden:list = None, allowed:list = None) -> bool:
    ...
    def frozenset(self, value:frozenset, terminate:bool = True, max_len:int = None, min_len:int = None,
        none_allowed:bool = False, forbidden:list = None, allowed:list = None) -> bool:
    ...
    # BOOLEAN TYPE
    def bool(self, value:bool, terminate:bool = True, none_allowed:bool = False) -> bool:
    ...
    def _report_mistakes(self, value, terminate, mistakes):
        if mistakes:
