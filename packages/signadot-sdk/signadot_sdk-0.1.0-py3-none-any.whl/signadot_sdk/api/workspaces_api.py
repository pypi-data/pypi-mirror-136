...
class WorkspacesApi(object):
    ...
    def create_new_workspace(self, org_name, data, **kwargs):  # noqa: E501
        """Create a new workspace  # noqa: E501

        Creates a new workspace with the provided parameters  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_new_workspace(org_name, data, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str org_name: Signadot Org Name (required)
        :param CreateWorkspaceRequest data: Request to create workspace (required)
        ...
        if kwargs.get('async_req'):
            return self.create_new_workspace_with_http_info(org_name, data, **kwargs)  # noqa: E501
        else:
            (data) = self.create_new_workspace_with_http_info(org_name, data, **kwargs)  # noqa: E501
            return data

    def create_new_workspace_with_http_info(self, org_name, data, **kwargs):  # noqa: E501
        """Create a new workspace  # noqa: E501

        Creates a new workspace with the provided parameters  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_new_workspace_with_http_info(org_name, data, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_new_workspace" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('org_name' not in params or
            ...
            raise ValueError("Missing the required parameter `org_name` when calling `create_new_workspace`")  # noqa: E501
        # verify the required parameter 'data' is set
        if self.api_client.client_side_validation and ('data' not in params or
                                                       params['data'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `data` when calling `create_new_workspace`")  # noqa: E501
    ...
    def delete_workspace_by_id(self, org_name, workspace_id, **kwargs):  # noqa: E501
        """Delete a Workspace by ID  # noqa: E501

        Delete the workspace when its ID is specified  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_workspace_by_id(org_name, workspace_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_workspace_by_id_with_http_info(org_name, workspace_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_workspace_by_id_with_http_info(org_name, workspace_id, **kwargs)  # noqa: E501
            return data

    def delete_workspace_by_id_with_http_info(self, org_name, workspace_id, **kwargs):  # noqa: E501
        """Delete a Workspace by ID  # noqa: E501

        Delete the workspace when its ID is specified  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_workspace_by_id_with_http_info(org_name, workspace_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['org_name', 'workspace_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_workspace_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'org_name' is set
        if self.api_client.client_side_validation and ('org_name' not in params or
                                                       params['org_name'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `org_name` when calling `delete_workspace_by_id`")  # noqa: E501
        # verify the required parameter 'workspace_id' is set
        if self.api_client.client_side_validation and ('workspace_id' not in params or
                                                       params['workspace_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `workspace_id` when calling `delete_workspace_by_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/orgs/{orgName}/workspaces/{workspaceId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_workspace_by_id(self, org_name, workspace_id, **kwargs):  # noqa: E501
        """Get a Workspace by ID  # noqa: E501

        Fetch the details about a workspace when its ID is specified  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_workspace_by_id(org_name, workspace_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_workspace_by_id_with_http_info(org_name, workspace_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_workspace_by_id_with_http_info(org_name, workspace_id, **kwargs)  # noqa: E501
            return data

    def get_workspace_by_id_with_http_info(self, org_name, workspace_id, **kwargs):  # noqa: E501
        """Get a Workspace by ID  # noqa: E501

        Fetch the details about a workspace when its ID is specified  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_workspace_by_id_with_http_info(org_name, workspace_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('org_name' not in params or
                                                       params['org_name'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `org_name` when calling `get_workspace_by_id`")  # noqa: E501
        # verify the required parameter 'workspace_id' is set
        if self.api_client.client_side_validation and ('workspace_id' not in params or
                                                       params['workspace_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `workspace_id` when calling `get_workspace_by_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/orgs/{orgName}/workspaces/{workspaceId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='GetWorkspaceByIdResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_workspace_ready(self, org_name, workspace_id, **kwargs):  # noqa: E501
        """Check workspace readiness  # noqa: E501

        Checks readiness of a workspace with rate limiting enforced by polling  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_workspace_ready(org_name, workspace_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str org_name: Signadot Org Name (required)
        :param str workspace_id: Workspace ID (required)
        :return: WorkspaceReadyResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_workspace_ready_with_http_info(org_name, workspace_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_workspace_ready_with_http_info(org_name, workspace_id, **kwargs)  # noqa: E501
            return data

    def get_workspace_ready_with_http_info(self, org_name, workspace_id, **kwargs):  # noqa: E501
        """Check workspace readiness  # noqa: E501

        Checks readiness of a workspace with rate limiting enforced by polling  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_workspace_ready_with_http_info(org_name, workspace_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_workspace_ready" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'org_name' is set
        if self.api_client.client_side_validation and ('org_name' not in params or
                                                       params['org_name'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `org_name` when calling `get_workspace_ready`")  # noqa: E501
        # verify the required parameter 'workspace_id' is set
        if self.api_client.client_side_validation and ('workspace_id' not in params or
                                                       params['workspace_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `workspace_id` when calling `get_workspace_ready`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/orgs/{orgName}/workspaces/{workspaceID}/ready', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='WorkspaceReadyResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_workspaces(self, org_name, **kwargs):  # noqa: E501
        """List Workspaces  # noqa: E501

        List all workspaces under the specified Signadot org.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_workspaces(org_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_workspaces_with_http_info(org_name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_workspaces_with_http_info(org_name, **kwargs)  # noqa: E501
            return data

    def get_workspaces_with_http_info(self, org_name, **kwargs):  # noqa: E501
        """List Workspaces  # noqa: E501

        List all workspaces under the specified Signadot org.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_workspaces_with_http_info(org_name, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('org_name' not in params or
                                                       params['org_name'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `org_name` when calling `get_workspaces`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GetWorkspacesResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
