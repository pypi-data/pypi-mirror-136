...
class File(filebase.TypeAlias):
    ...
    def hjoin(self, other_adaf):
        ...
        warnings.warn(
            "sympathy.typeutils.adaf.File.hjoin is deprecated "
    ...
    def vjoin(self, other_adafs, input_index, output_index, fill,
        ...
        """VJoin ADAF with other ADAF."""
        warnings.warn(
            "sympathy.typeutils.adaf.File.vjoin is deprecated "
            "and will be removed in version 4.0.0.",
            FutureWarning)
        try:
            return self._vjoin(
    ...
    def vsplit(self, other_adafs, input_index, remove_fill, require_index,
        ...
        """
        warnings.warn(
            "sympathy.typeutils.adaf.File.vsplit is deprecated "
            "and will be removed in version 4.0.0.",
            FutureWarning)
