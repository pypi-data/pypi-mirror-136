...
def set_use_opengles():
    import Qt
    # Other renderers are AA_UseDesktopOpenGL, AA_UseSoftwareOpenGL.
    if Qt.__binding__ in ['PySide2', 'PyQt5']:
        Qt.QtWidgets.QApplication.setAttribute(
            QtCore.Qt.AA_UseOpenGLES, True)


def setup_qt_opengl():
    set_shared_opengl_contexts()
    # Using GLES works around issues with on Windows for some configurations:
    # non-working QtWebEngine rendering and hanging shutdown atexit.
