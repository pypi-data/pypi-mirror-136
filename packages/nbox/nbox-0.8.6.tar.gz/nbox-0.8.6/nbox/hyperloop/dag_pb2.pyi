...
class Node(google.protobuf.message.Message):
    ...
    class Info(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["code",b"code","col_offset",b"col_offset","end_col_offset",b"end_col_offset","end_lineno",b"end_lineno","inputs",b"inputs","lineno",b"lineno","name",b"name","nbox_string",b"nbox_string","outputs",b"outputs"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["execution_index",b"execution_index","id",b"id","info",b"info","name",b"name","nbox_string",b"nbox_string","operator",b"operator","type",b"type"]) -> None: ...
global___Node = Node
