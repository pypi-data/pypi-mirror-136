...
class WorkflowFlowchartEdgeConfig:
    ...
    _from_node_config_id: str
    _id: str
    _to_node_config_id: str
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        field_dict.update(
            {
                "fromNodeConfigId": from_node_config_id,
                "id": id,
                "toNodeConfigId": to_node_config_id,
            }
        )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_from_node_config_id() -> str:
            from_node_config_id = d.pop("fromNodeConfigId")
            return from_node_config_id

        from_node_config_id = get_from_node_config_id() if "fromNodeConfigId" in d else cast(str, UNSET)
        ...
        def get_to_node_config_id() -> str:
            to_node_config_id = d.pop("toNodeConfigId")
            return to_node_config_id

        to_node_config_id = get_to_node_config_id() if "toNodeConfigId" in d else cast(str, UNSET)
