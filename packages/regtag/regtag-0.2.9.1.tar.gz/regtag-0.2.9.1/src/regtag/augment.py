...
if __name__ == "__main__":
    ...
    # print(get_random_oov('schoolsx'))
    # print(get_random_domain())
    # print(get_random_email())
    print(get_random_span())
    ...
    # oov_general = dict({})
    # list_words = []
    # with open('/Users/nguyenbinh/Desktop/top_word_genral', 'r', encoding='utf-8') as file:
    #     for line in file:
    #         word = line.split('\t')[0]
    #         list_words.append(word)
    #         if oov_en.get(word, None) is not None:
    #             oov_general[word] = oov_en[word]
    #         else:
    #             oov_general[word] = []
    #
    # with open('/Users/nguyenbinh/Desktop/top_word_genral.tsv', 'w', encoding='utf-8') as file:
    #     for w in list_words:
    #         file.write("{}\t{}\n".format(w, '\t'.join(oov_general[w])))
