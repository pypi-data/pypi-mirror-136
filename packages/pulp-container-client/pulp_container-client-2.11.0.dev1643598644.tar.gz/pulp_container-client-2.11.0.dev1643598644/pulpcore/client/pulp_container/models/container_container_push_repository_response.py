...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, pulp_href=None, latest_version_href=None, pulp_labels=None, versions_href=None, name=None, pulp_created=None, description=None, local_vars_configuration=None):  # noqa: E501
