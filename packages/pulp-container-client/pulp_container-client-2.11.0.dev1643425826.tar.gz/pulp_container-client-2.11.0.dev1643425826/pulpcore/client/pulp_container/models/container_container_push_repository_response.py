...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, description=None, versions_href=None, name=None, latest_version_href=None, retain_repo_versions=None, pulp_labels=None, pulp_created=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
