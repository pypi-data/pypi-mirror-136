...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, name=None, description=None, versions_href=None, pulp_created=None, pulp_href=None, retain_repo_versions=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
