...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, versions_href=None, pulp_href=None, latest_version_href=None, name=None, retain_repo_versions=None, pulp_labels=None, description=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
