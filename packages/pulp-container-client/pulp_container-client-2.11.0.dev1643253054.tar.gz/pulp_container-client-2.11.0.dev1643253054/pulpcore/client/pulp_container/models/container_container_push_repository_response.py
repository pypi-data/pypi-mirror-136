...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, latest_version_href=None, retain_repo_versions=None, pulp_labels=None, description=None, pulp_created=None, versions_href=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
