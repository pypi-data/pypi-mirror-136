...
def calc_gradient(base, values, gradient_type, halfwidth, min_num=2, min_range=0, default_gradient=0):
    return _gridpp.calc_gradient(base, values, gradient_type, halfwidth, min_num, min_range, default_gradient)
