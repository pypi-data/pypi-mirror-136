...
def download_data_from_server(server_url,page_size,save_csv_path="",save_rawdata_folder="",func_process=None,uploader="",tag="",use_fields="",sleep_time=-1,server_timeout=20,func_download_before=None):
