...
class Input():
    ...
    def __init__(self, config, window_length=None, shuffle=False, shuffle_buffer=1024, thresh=800, normalize=True):
        ...
        self.config = config
        self.input_width = len(config['input_feature']) if 'input_feature' in config.keys() else 1
