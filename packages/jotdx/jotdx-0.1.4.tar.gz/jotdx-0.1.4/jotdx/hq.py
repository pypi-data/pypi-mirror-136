...
from jotdx.parser.get_report_file import GetReportFile
...
class TdxHq_API(BaseSocketClient):
    ...
    def get_k_data(self, code, start_date, end_date):
        # 具体详情参见 https://github.com/rainx/jotdx/issues/5
        # 具体详情参见 https://github.com/rainx/jotdx/issues/21
        ...
        # https://github.com/rainx/jotdx/issues/33
        # 0 - 深圳， 1 - 上海
