...
# Imports from av-toolkit
from av_toolkit.ros.messages import MessageType
from av_toolkit.utils.files import file_exists, get_file_type, get_file_extension, read_text, get_resolved_path, as_path, copy_file
from av_toolkit.utils.logger import LOGGER
from av_toolkit.utils.yaml_parser import YAMLParser
...
class AVDataFileReader:
    ...
    def convert_to_pandas_df(self) -> pd.DataFrame:
        ...
        .. code-block:: python
            ...
            from av_toolkit.db import AVDataFileReader
