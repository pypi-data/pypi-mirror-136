...
from .fields import MultipleValueField, LookupCharField
from .widgets import ExtendedRangeWidget, ExtendedDateRangeWidget, FixedQueryArrayWidget, ExtendedTextInput
...
class ExtendedCharFilter(CharFilter):
    field_class = LookupCharField

    def __init__(self, *args, **kwargs):
        kwargs.setdefault("lookup_expr", "icontains")
        kwargs.setdefault("widget", ExtendedTextInput)
        super().__init__(*args, **kwargs)
