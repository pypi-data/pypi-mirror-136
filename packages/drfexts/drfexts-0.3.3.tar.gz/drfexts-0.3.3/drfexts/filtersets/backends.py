...
from .filters import (
    ...
    ExtendedDateFromToRangeFilter, ExtendedModelMultipleChoiceFilter,
)
...
FILTER_FOR_SERIALIZER_FIELD_DEFAULTS = ClassLookupDict(
    {
        ...
        serializers.ManyRelatedField: {'filter_class': ExtendedModelMultipleChoiceFilter, 'extra': lambda f: {"distinct": True, "queryset": f.child_relation.queryset}},
