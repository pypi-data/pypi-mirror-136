...
class Rule:
    ...
    def __init__(self, ID_rule_group: int, ID_org: int, title: str, active: int, type: RuleType, created_at: datetime, updated_at: datetime, deleted_at: None, rule_task: List[RuleTask], rule_workflows: List[RuleWorkflow]) -> None:
        self.ID_rule_group = ID_rule_group
        self.ID_org = ID_org
        self.title = title
        self.active = active
