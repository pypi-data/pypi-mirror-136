...
class PKMClient(object):
    ...
    def call(self, method='POST', path='', payload={}):
        ...
        try:
            ...
            print(f"PKMClient.call url: {url}, "
                  f"payload: {json.dumps(payload, indent=1)[:100]}…", file=sys.stderr)
    ...
    def update_invocation(self, project_id: str, invocation_id: str, status: int,
        ...
        if status == 0:
            ...
            invocationUpdate["invocationResults"] = resultsToAdd.update(
        ...
        if getSt >= 300:
            ...
            print(getSt, getTx, file=sys.stderr)
            inv = getTx
