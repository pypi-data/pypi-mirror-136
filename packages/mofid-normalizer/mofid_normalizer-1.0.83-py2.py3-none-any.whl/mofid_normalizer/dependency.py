"""
dependency parser codes, may be needed in the future version.
"""
...
#                     [str(i), word.replace(' ', '_'), self.stemmer(word, tag).replace(' ', '_'), tag, tag, '_', '0',
#                      'ROOT', '_', '_', '\n'])).encode('utf8'))
#             input_file.write('\n'.encode('utf8'))
#         input_file.close()
#
#         cmd = ['java', '-jar', self._malt_bin, '-w', self.working_dir, '-c', self.mco, '-i', input_file.name, '-o',
#                output_file.name, '-m', 'parse']
