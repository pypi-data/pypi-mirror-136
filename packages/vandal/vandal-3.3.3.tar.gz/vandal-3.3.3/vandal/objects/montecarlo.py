...
def Main():
    ...
    nparser.add_argument('-f', '--file', help = 'Enter file destination', type = str)
    nparser.add_argument('-t', '--time', help = 'Enter the time sequence', type = int)
    nparser.add_argument('-s', '--simulations', help = 'Enter the number of simulations', type = int)
    nparser.add_argument('-o', '--option', nargs = '*', help = 'Enter options', type = str, 
