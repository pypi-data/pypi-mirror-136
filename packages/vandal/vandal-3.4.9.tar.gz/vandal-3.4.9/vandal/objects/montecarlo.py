...
class MonteCarlo:
    ...
    def execute(self, list_of_values, time_seq, num_sims, ref_value_index = 0):
        ...
        print(Fore.YELLOW + f'Monte Carlo has been set up for {self.num_sims} simulations in a period of {self.time_seq} time measurement units and executed.' + Fore.RESET)
        ...
        print(end = '\r')
        print(Fore.YELLOW + 'Monte Carlo simulation set up and ready to plot.' + Fore.RESET)
        self.results = data
        return data
    ...
    def get_risk(self, risk_sims = 5000):
        ...
        print(Fore.GREEN + '\nRisk for this option is', round(NRisk,2), '%.' + Fore.RESET)
    ...
    def get_stats(self, filtered = False):
        ...
        if filtered == False:
            ...
            print(Fore.GREEN + 'Number of iterations: ', self.num_sims)
            print(Fore.GREEN + 'Mean value: ', mean_value)
            print(Fore.GREEN + 'Standard deviation: ', standard_deviation)
            print(Fore.GREEN + 'Maximum: ', maximum_value)
            print(Fore.GREEN + 'Minimum: ', minimum_value)
