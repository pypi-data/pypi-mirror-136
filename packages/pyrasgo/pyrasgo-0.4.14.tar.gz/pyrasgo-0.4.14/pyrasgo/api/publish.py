...
class Publish():
    ...
    def dataset(
        ...
        Args:
            ...
            timeseries_index: If the dataset is a timeseries with a date column, pass the name of the date column here
            attributes: Dictionary with metadata about the Dataset
        """
        ...
        if timeseries_index:
            if (attributes and "timeseries_index" not in attributes):
                attributes["timeseries_index"] = timeseries_index
            elif (attributes and "timeseries_index" in attributes):
                raise ValueError(
                    f"Timeseries index explicitly defined as"
                    f" {timeseries_index} in parameters, but defined as "
                    f"{attributes['timeseries_index']} in attributes dict. "
