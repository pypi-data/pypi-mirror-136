...
class Create():
    ...
    def _dataset_correlation_stats(self, *, table_id: int, dimension_column_id: Optional[int] = None, only_if_data_changed: Optional[bool] = True) -> None:
        """
        Trigger stats generation on a dataset
        """
        stats_create = schemas.GenerateStat(
            dwTableId=table_id,
            dimensionColumnId=dimension_column_id,
