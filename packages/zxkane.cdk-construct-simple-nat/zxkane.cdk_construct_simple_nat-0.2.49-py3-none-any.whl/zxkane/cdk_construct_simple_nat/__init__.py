...
class SimpleNAT(
    ...
    def __init__(
        ...
        *,
        ...
        nat_subnets_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection] = None,
        private_subnets_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection] = None,
    ...
    def with_github_route(self) -> "SimpleNAT":
        return typing.cast("SimpleNAT", jsii.invoke(self, "withGithubRoute", []))

    @jsii.member(jsii_name="withGoogleRoute")
    def with_google_route(self) -> "SimpleNAT":
        return typing.cast("SimpleNAT", jsii.invoke(self, "withGoogleRoute", []))
