...
# if True:
	...
	ax.semilogx(times, p_a/cryer.initialPressure, color='k', label="Analytical Solution")
	ax.scatter(times, p_n/initialPressure_n, marker='.', color='r', label="Numerical Solution")
