...
def main(meshName):
	boundaryConditions2D = PyEFVLib.BoundaryConditions({
		'u_x': {
			'InitialValue': 0.0,
		...
		'u_y': {
			...
			'North': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 1.0e+05 },
	...
	boundaryConditions3D = PyEFVLib.BoundaryConditions({
		'u_x': {
			'InitialValue': 0.0,
			'West': { 'condition' : PyEFVLib.Dirichlet, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
			'East': { 'condition' : PyEFVLib.Dirichlet, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
		...
		'u_z': {
			...
			'West': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
			'East': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 0.0 },
			'Top': { 'condition' : PyEFVLib.Neumann, 'type' : PyEFVLib.Constant, 'value' : 1.0e+05 },
	...
	problemData = PyEFVLib.ProblemData(
		...
		boundaryConditions = boundaryConditions2D if "1" in meshName else boundaryConditions3D,
