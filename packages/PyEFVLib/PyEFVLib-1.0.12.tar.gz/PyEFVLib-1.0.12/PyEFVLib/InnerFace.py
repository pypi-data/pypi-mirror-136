...
class InnerFace:
	...
	globalDerivatives	: np.ndarray[d, m]
		The gradient opeerator evaluated at the centroid of the innerFace.
	shapeFunctions 		: np.ndarray[m]
		The shape functions evaluated at the innerFace centroid

	Methods
	----------
	getNeighborVertices
		Returns the vertices that are right next to the innerFace.
	getNeighborVerticesLocals
		Returns the local indices of the vertices that are right next to the innerFace.
	getNeighborVerticesHandles
		Returns the global handles of the vertices that are right next to the innerFace.
	"""
