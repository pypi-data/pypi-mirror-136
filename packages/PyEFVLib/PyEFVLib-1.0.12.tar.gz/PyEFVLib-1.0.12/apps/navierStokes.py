...
def main():
	problemData = PyEFVLib.ProblemData(
		...
		numericalSettings = PyEFVLib.NumericalSettings( timeStep = 1000, tolerance = 1, maxNumberOfIterations = 600 ),
		...
		boundaryConditions = PyEFVLib.BoundaryConditions({
			'v_x': {
				'InitialValue': 0.0,
				'West': { 'condition' : PyEFVLib.Dirichlet, 'type' : PyEFVLib.Constant, 'value' : 10.0 },
				'East': { 'condition' : PyEFVLib.Dirichlet, 'type' : PyEFVLib.Constant, 'value' : 10.0 },
