...
extern tyProc__dsGSP5d71RCsLRHTMM4ScA Dl_13635132_;
extern tyProc__Rm9bSPgU9bryMLuDkmTLzYBA Dl_13635138_;
...
{	result = (tyEnum_ThreadPoolAdvice__vD9cAMuSmfH29a9al5Q9cUZCig)0;
	...
	nimZeroMem((void*)(&procUser), sizeof(tyObject_FILETIME__bs4NMleDDVF7xsEK0SGLBw));
	{
		...
		T3_ = (NIM_BOOL)0;
		T4_ = (NI32)0;
		T4_ = Dl_13635132_((&sysIdle), (&sysKernel), (&sysUser));
		T3_ = (T4_ == ((NI32) 0));
		if (T3_) goto LA5_;
		T6_ = (NI32)0;
		T6_ = Dl_13635138_(((NI) -1), (&procCreation), (&procExit), (&procKernel), (&procUser));
		T3_ = (T6_ == ((NI32) 0));
		LA5_: ;
		if (!T3_) goto LA7_;
		result = ((tyEnum_ThreadPoolAdvice__vD9cAMuSmfH29a9al5Q9cUZCig) 0);
