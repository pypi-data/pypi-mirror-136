...
N_LIB_PRIVATE N_NIMCALL(void, init__SlqsLPbuZZBq6DeaS10RpA)(tyObject_HashSet__bGAilYs5sUICRbD13gZaFg* s, NI initialSize) {
	...
	(*s).counter = ((NI) 0);
	unsureAsgnRef((void**) (&(*s).data), (tySequence__8Np6tlClE5az1CyqZdN19bQ*) newSeq((&NTI__8Np6tlClE5az1CyqZdN19bQ_), ((NI) (correctSizeX60gensym4_))));
}
...
N_LIB_PRIVATE N_NIMCALL(void, rawInsert__OOTsYp9cA9bo6G9cRkmS28ARw)(tyObject_HashSet__bGAilYs5sUICRbD13gZaFg* s, tySequence__8Np6tlClE5az1CyqZdN19bQ** data, NI key, NI hc, NI h) {
	{
		...
		(*s).counter = ((NI) 0);
		unsureAsgnRef((void**) (&(*s).data), (tySequence__8Np6tlClE5az1CyqZdN19bQ*) newSeq((&NTI__8Np6tlClE5az1CyqZdN19bQ_), ((NI) (correctSizeX60gensym17_))));
	}
	LA4_: ;
		...
		res = ((NI) 0);
		{
			while (1) {
				...
				i = res;
				{
					...
					j = (NI)(((NI) -1) - T12_);
					rawInsert__OOTsYp9cA9bo6G9cRkmS28ARw(s, (&(*s).data), n->data[i].Field1, n->data[i].Field0, j);
				}
				LA10_: ;
				res += ((NI) 1);
			} LA6: ;
...
N_LIB_PRIVATE N_NIMCALL(void, incl__1iC9b07BJ0YbbEQvo9cYeAdQ)(tyObject_HashSet__bGAilYs5sUICRbD13gZaFg* s, NI key) {
	...
	NI index;
	{
		...
		(*s).counter = ((NI) 0);
		unsureAsgnRef((void**) (&(*s).data), (tySequence__8Np6tlClE5az1CyqZdN19bQ*) newSeq((&NTI__8Np6tlClE5az1CyqZdN19bQ_), ((NI) (correctSizeX60gensym8_))));
	}
	LA4_: ;
	hc = (NI)0;
	index = rawGet__HGBKgQ9csklpnOOb48DARgAsets((*s), key, (&hc));
	{
		...
		LA13_: ;
		rawInsert__OOTsYp9cA9bo6G9cRkmS28ARw(s, (&(*s).data), key, hc, (NI)(((NI) -1) - index));
		(*s).counter += ((NI) 1);
	}
	LA8_: ;
}
