...
tyProc__PD9b9cqhDqM6Xy1oSxwODsOQ Dl_16272201_;
tyProc__PD9b9cqhDqM6Xy1oSxwODsOQ Dl_16272205_;
...
N_LIB_PRIVATE N_NIMCALL(tyObject_MonoTime__FEvFMlkqJiSSGVO6HgTv8w, plus___kq5bd8gLWmWN2ZS9bs8371Q)(tyObject_MonoTime__FEvFMlkqJiSSGVO6HgTv8w a, tyObject_Duration__lj9ar6Co3fgk6NgGnVaNpJw b) {
	...
	T2_ = (NI64)0;
	T2_ = inNanoseconds__df0d89cDnRIju9aB6p1W1qVA_2(b);
...
if (!((TM__IP4V1hRabVpf8OnX9bWuPxw_2 = nimLoadLibrary(((NimStringDesc*) &TM__IP4V1hRabVpf8OnX9bWuPxw_4)))
	...
	Dl_16272201_ = (tyProc__PD9b9cqhDqM6Xy1oSxwODsOQ) nimGetProcAddr(TM__IP4V1hRabVpf8OnX9bWuPxw_2, "QueryPerformanceCounter");
	Dl_16272205_ = (tyProc__PD9b9cqhDqM6Xy1oSxwODsOQ) nimGetProcAddr(TM__IP4V1hRabVpf8OnX9bWuPxw_2, "QueryPerformanceFrequency");
}
