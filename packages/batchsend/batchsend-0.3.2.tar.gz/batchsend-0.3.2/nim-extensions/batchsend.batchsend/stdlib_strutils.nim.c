...
appendString((*s), a[idx_2]);
					...
					LA55_: ;
					{
						...
						NimStringDesc* T69_;
						T69_ = NIM_NIL;
						T69_ = substr__system_8545(formatstr, (NI)(i + ((NI) 2)), (NI)(j_2 - ((NI) 1)));
...
appendString((*s), a[(NI)(x + ((NI) 1))]);
				...
				case 95:
				{
					...
					T82_ = NIM_NIL;
					T82_ = substr__system_8545(formatstr, (NI)(i + ((NI) 1)), (NI)(j_3 - ((NI) 1)));
	...
	LA3_: ;
	{
		...
		i = ((NI) 0);
		{
			while (1) {
				...
				LA12_: ;
				T14_ = NIM_NIL;
				T14_ = substr__system_8545(s, i, (NI)(j - ((NI) 1)));
	...
	LA6_: ;
	{
		...
		i_2 = ((NI) 0);
		{
			while (1) {
				...
				LA21_: ;
				T23_ = NIM_NIL;
				T23_ = substr__system_8545(s, i_2, (NI)(j_2 - ((NI) 1)));
...
appendString(result, by);
		...
		T24_ = NIM_NIL;
		T24_ = substr__system_8557(s, i_2);
