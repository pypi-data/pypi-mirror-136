...
N_LIB_PRIVATE N_NIMCALL(void, libCandidates__pureZdynlib_37)(NimStringDesc* s, tySequence__sM4lkSb7zS6F7OVMvW9cffQ** dest) {
	...
	ri = nsuFindChar(s, 41, ((NI) ((NI)(le + ((NI) 1)))), ((NI) 0));
	{
		...
		LA4_: ;
		if (!T3_) goto LA5_;
		prefix = substr__system_8545(s, ((NI) 0), (NI)(le - ((NI) 1)));
		suffix = substr__system_8557(s, (NI)(ri + ((NI) 1)));
		{
			...
			middle = NIM_NIL;
			colontmp_ = NIM_NIL;
			colontmp_ = substr__system_8545(s, (NI)(le + ((NI) 1)), (NI)(ri - ((NI) 1)));
			...
			splitsX60gensym34_ = ((NI) -1);
			{
				while (1) {
					...
					LA16_: ;
					middle = substr__system_8545(colontmp_, firstX60gensym34_, (NI)(lastX60gensym34_ - ((NI) 1)));
					T18_ = NIM_NIL;
...
N_LIB_PRIVATE N_NIMCALL(void*, loadLibPattern__pureZdynlib_49)(NimStringDesc* pattern, NIM_BOOL globalSymbols) {
	...
	result = (void*)0;
	candidates = newSeq__systemZio_640(((NI) 0));
