...
static N_INLINE(NIM_BOOL, checkObjSubclass__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95utils_32)(void* o, tyObject_PyTypeObject3Obj__cRsC9bGvH9bX6A9aVx8UB6I5g* ty);
N_LIB_PRIVATE N_NIMCALL(void, conversionToStringError__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95utils_42)(void);
...
static N_INLINE(NIM_BOOL, checkObjSubclass__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95utils_32)(void* o, tyObject_PyTypeObject3Obj__cRsC9bGvH9bX6A9aVx8UB6I5g* ty) {
	...
	if (T1_) goto LA2_;
	T3_ = (int)0;
	T3_ = (*pyLib__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95lib_277).PyType_IsSubtype(typ, ty);
	T1_ = !((T3_ == ((NI32) 0)));
	LA2_: ;
	result = T1_;
	return result;
...
{	result = (NIM_BOOL)0;
	...
	b = (void*)0;
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = checkObjSubclass__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95utils_32(o, (*pyLib__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95lib_277).PyUnicode_Type);
		if (!T3_) goto LA4_;
		b = (*pyLib__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95lib_277).PyUnicode_AsUTF8String(o);
		{
			if (!(b == 0)) goto LA8_;
			conversionToStringError__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95utils_42();
		}
		LA8_: ;
		{
			int T12_;
			T12_ = (int)0;
			T12_ = (*pyLib__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95lib_277).PyBytes_AsStringAndSize(b, &s, (&l));
			if (!!((T12_ == ((NI32) 0)))) goto LA13_;
			decRef__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95utils_15(b);
			conversionToStringError__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95utils_42();
		}
		LA13_: ;
	}
	...
	LA4_: ;
	{
		NIM_BOOL T16_;
		T16_ = (NIM_BOOL)0;
		T16_ = checkObjSubclass__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95utils_32(o, (*pyLib__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95lib_277).PyBytes_Type);
		if (!T16_) goto LA17_;
		{
			int T21_;
			T21_ = (int)0;
			T21_ = (*pyLib__6758Z85sersZrunneradminZOnimbleZpkgsZnimpy4548O50O48ZnimpyZpy95lib_277).PyBytes_AsStringAndSize(o, &s, (&l));
