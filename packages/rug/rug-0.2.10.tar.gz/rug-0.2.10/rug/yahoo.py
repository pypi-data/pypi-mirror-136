    ...
    def get_current_price_change(self):
        ...
        * post_market
        ...
        return {
            ...
            "pre_market": {
                "change": {
                    "percents": float(data.get("preMarketChangePercent", {}).get("raw", 0)) * 100,
            ...
            "current_market": {
                "change": {
                    "percents": float(data.get("regularMarketChangePercent", {}).get("raw", 0)) * 100,
            ...
            "post_market": {
                "change": {
                    "percents": float(data.get("postMarketChangePercent", {}).get("raw", 0)) * 100,
