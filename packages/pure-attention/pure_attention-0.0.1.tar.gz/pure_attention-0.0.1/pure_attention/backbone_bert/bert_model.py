...
from bert.bert_layer import BertEmbeddings
...
if __name__ == "__main__":
    """
from common.nlp.tokenization import Tokenizer
from common.bert.bert_model import BertModel
tokenizer = Tokenizer("/data1/lifeiyang/data/pretrain_modal/chinese-roberta-wwm-ext/vocab.txt")
bert = BertModel("/data1/lifeiyang/data/pretrain_modal/chinese-roberta-wwm-ext")

sentence = "123"
tokens_ids, segments_ids = tokenizer.encode("123", max_len=64)

_ = bert(tokens_ids,token_type_ids=segments_ids)[1]
print("pass")
