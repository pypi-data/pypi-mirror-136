...
@Gooey(
    ...
    # sidebar_title='FOOO',
    # cli='"C:\\Users\\Chris\\Documents\\Gooey\\venv368\\Scripts\\python.exe" -u "C:/Users/Chris/Documents/Gooey/gooey/examples/subparser_demo.py" curl --gooey-validate-form -- ::gooey/placeholder',
...
def main():
  ...
  parser.parse_args()
  # parser.parse_args('curl --gooey-validate-form -- ::gooey/placeholder'.split())
