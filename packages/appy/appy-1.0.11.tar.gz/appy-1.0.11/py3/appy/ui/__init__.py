...
class Config:
    ...
    def __init__(self):
        ...
        self.pgMargin = '0.5em 2px 0.3em' # *p*ortlet *group margins
        ...
        self.topIconsMargin = '0 10px 0 0px'
        ...
        # Buttons. Most buttons appear on top of dark backgrounds. Buttons
        # appearing in standard bright backgrounds use p_self.darkColor and not
        # this p_self.buttonColor.
