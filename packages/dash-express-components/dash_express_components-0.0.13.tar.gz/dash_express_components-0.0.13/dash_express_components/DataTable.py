...
- data (dict with strings as keys and values of type list of string | number | booleans; optional):
...
- filter_action (dict; default 'native'):
...
- persisted_props (list of a value equal to: 'columns.name', 'data', 'filter_query', 'hidden_columns', 'page_current', 'selected_columns', 'selected_rows', 'sort_by's; default [    'columns.name',    'filter_query',    'hidden_columns',    'selected_columns',    'sort_by']):
...
- row_selectable (a value equal to: 'single', 'multi', false; default "multi"):
...
- sort_action (a value equal to: 'custom', 'native', 'none'; default 'native'):
...
- sort_mode (a value equal to: 'single', 'multi'; default 'multi'):
