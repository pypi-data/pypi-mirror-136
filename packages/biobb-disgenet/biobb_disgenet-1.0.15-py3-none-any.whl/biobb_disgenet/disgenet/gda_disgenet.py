...
class GDA_disgenet(BiobbObject):
    ...
    def __init__(self, retrieve_by, output_file_path, email, password,
        ...
        # Input/Output files
        self.io_dict = { 
                'in': {'retrieve_by': retrieve_by, 'email': email, 'password': password}, 
...
#        self.properties = properties
    ...
    def launch(self) -> int:
        ...
        auth_session(request, new_keys, self.io_dict["in"]["email"],  self.io_dict["in"]["password"], output_path, self.out_log, self.global_log)       
        
        return self.return_code

def gda_disgenet(retrieve_by: str, output_file_path: str, email: str, password: str,  properties: dict = None, **kwargs) -> int:
