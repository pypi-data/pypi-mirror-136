...
#    auth_params = {"email": args.email,"password": args.password}
    ...
    if not email:
        ...
        auth_params = {"e-mail": email ,"password": password}
        print (auth_params)
        ...
        try: 
            ...
            data = json.dumps(auth_params, content_type='application/json')
            print (api_host+'/auth/'+data)
            r = s.post(api_host+'/auth/',data=data)
