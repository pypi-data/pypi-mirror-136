...
class GDA_disgenet(BiobbObject):
    ...
    def __init__(self, retrieve_by, output_file_path, e-mail, password,
        ...
        # Input/Output files
        self.io_dict = { 
                'in': {'retrieve_by': retrieve_by, 'e-mail': e-mail, 'password': password}, 
...
#        self.properties = properties
    ...
    def launch(self) -> int:
        ...
        auth_session(request, new_keys, self.io_dict["in"]["e-mail"],  self.io_dict["in"]["password"], output_path, self.out_log, self.global_log)       
        
        return self.return_code

def gda_disgenet(retrieve_by: str, output_file_path: str, e-mail: str, password: str,  properties: dict = None, **kwargs) -> int:
...
def main():
    ...
    required_args.add_argument('-e-mail',  required=True)
