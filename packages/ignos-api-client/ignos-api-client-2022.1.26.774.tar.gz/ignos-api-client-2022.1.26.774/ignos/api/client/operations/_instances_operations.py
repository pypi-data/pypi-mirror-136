...
def build_list_active_measurement_forms_request(
    **kwargs  # type: Any
    ...
    # Construct URL
    url = kwargs.pop("template_url", '/measurementforms/instances')
...
def build_create_measurement_form_instance_request(
    ...
    **kwargs  # type: Any
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/measurementforms/instances/workorders/{id}')
...
class InstancesOperations(object):
    ...
    def create_measurement_form_instance(
        self,
        id,  # type: str
        body=None,  # type: Optional["_models.CreateMeasurementFormInstance"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Any
