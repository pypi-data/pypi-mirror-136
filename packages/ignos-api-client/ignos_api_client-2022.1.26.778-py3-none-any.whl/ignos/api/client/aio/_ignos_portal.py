...
from .operations import AppsOperations, AssetsOperations, AzureRegionsOperations, CdfClustersOperations, CdfOperations, CountriesOperations, CustomerOrdersOperations, CustomersOperations, DatabasesOperations, ElectricalOperations, ExternalAccessOperations, ExternalOperations, InstancesOperations, MachineAlarmsOperations, MachineUtilizationOperations, MeOperations, MeasuringToolsOperations, PowerOperations, SchemasOperations, SuppliersOperations, SustainabilityOperations, UploadOperations, UserOperations, WeldingOperations, WorkordersOperations
...
class IgnosPortal:
    ...
    :vartype instances: ignos.api.client.aio.operations.InstancesOperations
    :ivar schemas: SchemasOperations operations
    :vartype schemas: ignos.api.client.aio.operations.SchemasOperations
