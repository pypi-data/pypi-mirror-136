...
from gateways.common.cs18_api_classes import AccessLink, TerraformModuleDescriptor, TerraformModuleComputeService, \
    ...
    SpaceHelmChartComputeService, SpaceHelmChartPlugin
...
class Converters:
    ...
    @staticmethod
    def convert_space_helm_chart_plugin(plugin_item: dict) -> SpaceHelmChartPlugin:
        return SpaceHelmChartPlugin(
            path=plugin_item["path"],
            version=plugin_item["version"],
            command=plugin_item["command"]
        )
