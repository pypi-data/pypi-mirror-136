...
from gateways.common.cs18_api_classes import HelmChartDescriptor, \
    SpaceHelmChartInput, SpaceHelmChartComputeService, SpaceHelmChartOutput, SpaceHelmChartPlugin
...
class SpaceHelmChartModuleResponse:
    def __init__(
            ...
            modified_by: str,
            last_modified: datetime,
            plugins: Optional[List[SpaceHelmChartPlugin]] = None
    ):
        self.chart_descriptor = HelmChartDescriptor(name=name, perform_helm_test=perform_helm_test,
                                                    ...
                                                    override_values_yaml=override_values_yaml, plugins=plugins)
        self.created_by = created_by
        self.created_date = created_date
        self.modified_by = modified_by
        self.last_modified = last_modified
