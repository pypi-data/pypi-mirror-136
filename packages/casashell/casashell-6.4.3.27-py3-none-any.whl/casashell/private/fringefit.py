...
##################### 94792e06bab09d4b1eace3fc4f874f30 ##############################
...
class _fringefit:
    ...
    def __call__( self, vis=None, caltable=None, field=None, spw=None, intent=None, selectdata=None, timerange=None, antenna=None, scan=None, observation=None, msselect=None, solint=None, combine=None, refant=None, minsnr=None, zerorates=None, globalsolve=None, niter=None, delaywindow=None, ratewindow=None, append=None, corrdepflags=None, docallib=None, callib=None, gaintable=None, gainfield=None, interp=None, spwmap=None, paramactive=None, parang=None ):
        def noobj(s):
           if s.startswith('<') and s.endswith('>'):
               return "None"
           else:
        ...
        _arguments = [vis,caltable,field,spw,intent,selectdata,timerange,antenna,scan,observation,msselect,solint,combine,refant,minsnr,zerorates,globalsolve,niter,delaywindow,ratewindow,append,corrdepflags,docallib,callib,gaintable,gainfield,interp,spwmap,paramactive,parang]
        _invocation_parameters = OrderedDict( )
