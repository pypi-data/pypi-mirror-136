...
def lazy_import():
    ...
    globals()['SettingsOut'] = SettingsOut


class ExportOrganizationOut(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'event_types': ([EventTypeOut],),  # noqa: E501
            'settings': (SettingsOut, none_type),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, event_types, *args, **kwargs):  # noqa: E501
        """ExportOrganizationOut - a model defined in OpenAPI

        Args:
            created_at (datetime):
            event_types ([EventTypeOut]):
        ...
        Keyword Args:
            ...
            settings (SettingsOut): [optional]  # noqa: E501
            version (int): [optional] if omitted the server will use the default value of 1  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_at, event_types, *args, **kwargs):  # noqa: E501
        """ExportOrganizationOut - a model defined in OpenAPI
