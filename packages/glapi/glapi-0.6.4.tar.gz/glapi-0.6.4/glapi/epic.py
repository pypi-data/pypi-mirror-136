...
class GitlabEpic:
    ...
    def __init__(self, id: str = None, iid: str = None, epic: dict = None, group_id: str = None, group_users: list = None, issues: list = None, get_issues: bool = False, get_notes: bool = False, get_participants: bool = False, token :str = configuration.GITLAB_TOKEN, version: str = configuration.GITLAB_API_VERSION):
        """
        Args:
