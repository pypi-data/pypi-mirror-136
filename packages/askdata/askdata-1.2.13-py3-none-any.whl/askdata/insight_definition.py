...
class Insight_Definition:
    ...
    def edit_chart(self, chart_id, chart_type:str, query:str, params, title = "Chart"):
        ...
        url_preview = self.smart_insight_url+"/composed_queries/"+qc["settings"]["qc"]+"/preview?limit=100"
    ...
    def add_to_channel(self, original_channel_id, new_channel_id):
        url = self._base_url_askdata + "/smartfeed/pin/pinned/"+original_channel_id+"?addMode=true"
        body = [
            {
                "targetId": new_channel_id,
                "type": "CARD",
                "pinnedValues": {}
            }
        ]
