...
namespace __pythran__group_columns
{
  ...
  typename group_sparse::type<argument_type0, argument_type1, argument_type2, argument_type3>::result_type group_sparse::operator()(argument_type0&& m, argument_type1&& n, argument_type2&& indices, argument_type3&& indptr) const
  {
    ...
    {
      long  __target140520583324240 = n;
      for (long  i=0L; i < __target140520583324240; i += 1L)
      {
        ...
        {
          long  __target140520583327216 = indptr[pythonic::operator_::add(i, 1L)];
          for (long  k=indptr[i]; k < __target140520583327216; k += 1L)
          {
            union_[indices[k]] = 1L;
          }
        }
        {
          long  __target140520583426112 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, groups));
          for (long  j=0L; j < __target140520583426112; j += 1L)
          {
            ...
            {
              long  __target140520583428512 = indptr[pythonic::operator_::add(j, 1L)];
              for (long  k_=indptr[j]; k_ < __target140520583428512; k_ += 1L)
              {
            ...
            {
              {
                long  __target140520583370688 = indptr[pythonic::operator_::add(j, 1L)];
                for (long  k__=indptr[j]; k__ < __target140520583370688; k__ += 1L)
                {
  ...
  typename group_dense::type<argument_type0, argument_type1, argument_type2>::result_type group_dense::operator()(argument_type0&& m, argument_type1&& n, argument_type2&& A) const
  {
    ...
    {
      long  __target140520580643904 = n;
      for (long  i=0L; i < __target140520580643904; i += 1L)
      {
        if (pythonic::operator_::ge(groups[i], 0L))
        {
          continue;
        ...
        {
          long  __target140520585367904 = std::get<0>(pythonic::builtins::getattr(pythonic::types::attr::SHAPE{}, groups));
          for (long  j=0L; j < __target140520585367904; j += 1L)
          {
            if (pythonic::operator_::lt(groups[j], 0L))
            {
              all_grouped = false;
            ...
            typename pythonic::lazy<decltype(false)>::type intersect = false;
            {
              long  __target140520585369440 = m;
              for (long  k=0L; k < __target140520585369440; k += 1L)
              {
