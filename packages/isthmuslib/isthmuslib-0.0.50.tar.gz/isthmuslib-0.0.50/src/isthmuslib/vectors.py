...
class VectorMultiset(PickleUtils, Style, Rosetta):
    ...
    def scatter(self, *args, **kwargs) -> plt.Figure:
        ...
        return self.visualize_x_y(x_name=args[0], y_name=args[1], **kwargs, types='scatter')
    ...
    def plot(self, *args, **kwargs) -> plt.Figure:
        ...
        return self.visualize_x_y(x_name=args[0], y_name=args[1], **kwargs, types='line')
...
def extract_from_text(input_string: str, record_delimiter: str, tokens_dictionary: Dict[str, Tuple[str, str]],
...
def extract_from_file(file_path: Union[str, pathlib.Path], record_delimiter: str,
    ...
    with open(file_path, 'r') as f:
        return extract_from_text(input_string=f.read(), record_delimiter=record_delimiter,
