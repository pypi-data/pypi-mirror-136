...
class TimeSeries():
    ...
    def timesSeriesGroupData(self, inventoryName:str, fromTimepoint:str, toTimepoint:str, 
    ...
    def timesSeriesGroupDataReduced(self, inventoryName:str, fromTimepoint:str, toTimepoint:str, 
