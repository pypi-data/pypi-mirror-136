/*! For license information please see 2fdea9ab.js.LICENSE.txt */
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[98085],{99257:(t,i,e)=>{e(65233);var a=e(15112),n=e(9672),o=e(87156);(0,n.k)({is:"iron-iconset-svg",properties:{name:{type:String,observer:"_nameChanged"},size:{type:Number,value:24},rtlMirroring:{type:Boolean,value:!1},useGlobalRtlAttribute:{type:Boolean,value:!1}},created:function(){this._meta=new a.P({type:"iconset",key:null,value:null})},attached:function(){this.style.display="none"},getIconNames:function(){return this._icons=this._createIconMap(),Object.keys(this._icons).map((function(t){return this.name+":"+t}),this)},applyIcon:function(t,i){this.removeIcon(t);var e=this._cloneIcon(i,this.rtlMirroring&&this._targetIsRTL(t));if(e){var a=(0,o.vz)(t.root||t);return a.insertBefore(e,a.childNodes[0]),t._svgIcon=e}return null},removeIcon:function(t){t._svgIcon&&((0,o.vz)(t.root||t).removeChild(t._svgIcon),t._svgIcon=null)},_targetIsRTL:function(t){if(null==this.__targetIsRTL)if(this.useGlobalRtlAttribute){var i=document.body&&document.body.hasAttribute("dir")?document.body:document.documentElement;this.__targetIsRTL="rtl"===i.getAttribute("dir")}else t&&t.nodeType!==Node.ELEMENT_NODE&&(t=t.host),this.__targetIsRTL=t&&"rtl"===window.getComputedStyle(t).direction;return this.__targetIsRTL},_nameChanged:function(){this._meta.value=null,this._meta.key=this.name,this._meta.value=this,this.async((function(){this.fire("iron-iconset-added",this,{node:window})}))},_createIconMap:function(){var t=Object.create(null);return(0,o.vz)(this).querySelectorAll("[id]").forEach((function(i){t[i.id]=i})),t},_cloneIcon:function(t,i){return this._icons=this._icons||this._createIconMap(),this._prepareSvgClone(this._icons[t],this.size,i)},_prepareSvgClone:function(t,i,e){if(t){var a=t.cloneNode(!0),n=document.createElementNS("http://www.w3.org/2000/svg","svg"),o=a.getAttribute("viewBox")||"0 0 "+i+" "+i,s="pointer-events: none; display: block; width: 100%; height: 100%;";return e&&a.hasAttribute("mirror-in-rtl")&&(s+="-webkit-transform:scale(-1,1);transform:scale(-1,1);transform-origin:center;"),n.setAttribute("viewBox",o),n.setAttribute("preserveAspectRatio","xMidYMid meet"),n.setAttribute("focusable","false"),n.style.cssText=s,n.appendChild(a).removeAttribute("id"),n}return null}})},54242:(t,i,e)=>{e(65233);const a=e(50856).d`
<custom-style>
...
</custom-style>`;a.setAttribute("style","display: none;"),document.head.appendChild(a.content)},54444:(t,i,e)=>{e(65233);var a=e(9672),n=e(87156),o=e(50856);(0,a.k)({_template:o.d`
    <style>
      :host {
        display: block;
        position: absolute;
...
//# sourceMappingURL=2fdea9ab.js.map