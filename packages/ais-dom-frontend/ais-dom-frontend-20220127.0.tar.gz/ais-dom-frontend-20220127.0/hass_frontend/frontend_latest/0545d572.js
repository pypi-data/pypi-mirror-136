...
"use strict";(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[13228,640],{54930:(e,t,r)=>{r.d(t,{D:()=>h});var i=r(87480),n=r(26767),o=r(38103),a=r(37500),s=r(5701),c=r(228),l=r(48399),d=r(47501);class p extends a.oi{constructor(){super(...arguments),this.indeterminate=!1,this.progress=0,this.density=0,this.closed=!1}open(){this.closed=!1}close(){this.closed=!0}render(){const e={"mdc-circular-progress--closed":this.closed,"mdc-circular-progress--indeterminate":this.indeterminate},t=48+4*this.density,r={width:`${t}px`,height:`${t}px`};return a.dy`
  ...
  <paper-icon-item>
    ...
    `}},{kind:"method",key:"_openedChanged",value:async function(e){if(this._opened=e.detail.value,this._opened&&!k.length){const e=await r.e(71639).then(r.t.bind(r,71639,19));k=e.default.map((e=>({icon:`mdi:${e.name}`,keywords:e.keywords}))),this.comboBox.filteredItems=k,Object.keys(d.g).forEach((e=>{this._loadCustomIconItems(e)}))}}},{kind:"method",key:"_loadCustomIconItems",value:async function(e){try{const t=d.g[e].getIconList;if("function"!=typeof t)return;const r=(await t()).map((t=>{var r;return{icon:`${e}:${t.name}`,keywords:null!==(r=t.keywords)&&void 0!==r?r:[]}}));k.push(...r),this.comboBox.filteredItems=k}catch(t){console.warn(`Unable to load icon list for ${e} iconset`)}}},{kind:"method",key:"_valueChanged",value:function(e){this._setValue(e.detail.value)}},{kind:"method",key:"_setValue",value:function(e){this.value=e,(0,l.B)(this,"value-changed",{value:e},{bubbles:!1,composed:!1})}},{kind:"method",key:"_filterChanged",value:function(e){const t=e.detail.value.toLowerCase();if(t.length>=2){const e=[],r=[];k.forEach((i=>{i.icon.includes(t)?e.push(i):i.keywords.some((e=>e.includes(t)))&&r.push(i)})),e.push(...r),e.length>0?this.comboBox.filteredItems=e:this.comboBox.filteredItems=[{icon:t,keywords:[]}]}else this.comboBox.filteredItems=k}},{kind:"get",key:"_value",value:function(){return this.value||""}},{kind:"get",static:!0,key:"styles",value:function(){return i.iv`
      ha-icon,
      ha-svg-icon {
        position: relative;
        bottom: 2px;
    ...
    `:i.dy``}},{kind:"method",key:"shouldUpdate",value:function(e){const t=e.get("hass");return!t||t.locale!==this.hass.locale}},{kind:"method",key:"firstUpdated",value:function(){if(!this.hass||!this.lovelace)return;const e=(0,f.zJ)(this.lovelace),t=(0,f.Xr)(this.hass,e);this._usedEntities=[...e].filter((e=>this.hass.states[e]&&!u.V_.includes(this.hass.states[e].state))),this._unusedEntities=[...t].filter((e=>this.hass.states[e]&&!u.V_.includes(this.hass.states[e].state))),this._loadCards()}},{kind:"method",key:"_loadCards",value:function(){let e=v.C.map((e=>({name:this.hass.localize(`ui.panel.lovelace.editor.card.${e.type}.name`),description:this.hass.localize(`ui.panel.lovelace.editor.card.${e.type}.description`),...e})));h.kb.length>0&&(e=e.concat(h.kb.map((e=>({type:e.type,name:e.name,description:e.description,showElement:e.preview,isCustom:!0}))))),this._cards=e.map((e=>({card:e,element:i.dy`${(0,l.C)(this._renderCardElement(e),i.dy`
          <div class="card spinner">
            <ha-circular-progress active alt="Loading"></ha-circular-progress>
          </div>
        `)}`})))}},{kind:"method",key:"_handleSearchChange",value:function(e){const t=e.detail.value;if(t){if(!this._width||!this._height){const e=this.shadowRoot.getElementById("content");if(e&&!this._width){const t=e.clientWidth;t&&(this._width=t)}if(e&&!this._height){const t=e.clientHeight;t&&(this._height=t)}}}else this._width=void 0,this._height=void 0;this._filter=t}},{kind:"method",key:"_cardPicked",value:function(e){const t=e.currentTarget.config;(0,p.B)(this,"config-changed",{config:t})}},{kind:"method",key:"_tryCreateCardElement",value:function(e){const t=(0,m.l$)(e);return t.hass=this.hass,t.addEventListener("ll-rebuild",(r=>{r.stopPropagation(),this._rebuildCard(t,e)}),{once:!0}),t}},{kind:"method",key:"_rebuildCard",value:function(e,t){let r;try{r=this._tryCreateCardElement(t)}catch(e){return}e.parentElement&&e.parentElement.replaceChild(r,e)}},{kind:"method",key:"_renderCardElement",value:async function(e){let{type:t}=e;const{showElement:r,isCustom:n,name:o,description:a}=e,c=n?(0,h.cs)(t):void 0;let l;n&&(t=`${h.Qo}${t}`);let d={type:t};if(this.hass&&this.lovelace&&(d=await(0,y.U)(this.hass,t,this._unusedEntities,this._usedEntities),r))try{l=this._tryCreateCardElement(d)}catch(e){l=void 0}return i.dy`
      <div class="card">
        <div
          class="overlay"
          @click=${this._cardPicked}
...
//# sourceMappingURL=0545d572.js.map