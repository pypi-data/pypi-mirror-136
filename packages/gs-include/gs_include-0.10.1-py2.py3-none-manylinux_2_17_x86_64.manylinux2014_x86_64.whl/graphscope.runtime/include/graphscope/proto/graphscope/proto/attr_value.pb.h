...
// string op_key = 2;
inline void ChunkMeta::clear_op_key() {
  op_key_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& ChunkMeta::op_key() const {
  // @@protoc_insertion_point(field_get:gs.rpc.ChunkMeta.op_key)
  return _internal_op_key();
}
inline void ChunkMeta::set_op_key(const std::string& value) {
  _internal_set_op_key(value);
  // @@protoc_insertion_point(field_set:gs.rpc.ChunkMeta.op_key)
}
inline std::string* ChunkMeta::mutable_op_key() {
  // @@protoc_insertion_point(field_mutable:gs.rpc.ChunkMeta.op_key)
  return _internal_mutable_op_key();
}
inline const std::string& ChunkMeta::_internal_op_key() const {
  return op_key_.Get();
}
inline void ChunkMeta::_internal_set_op_key(const std::string& value) {
  
  op_key_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void ChunkMeta::set_op_key(std::string&& value) {
  
  op_key_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:gs.rpc.ChunkMeta.op_key)
}
inline void ChunkMeta::set_op_key(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  op_key_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:gs.rpc.ChunkMeta.op_key)
}
inline void ChunkMeta::set_op_key(const char* value,
    size_t size) {
  ...
  op_key_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:gs.rpc.ChunkMeta.op_key)
}
inline std::string* ChunkMeta::_internal_mutable_op_key() {
  
  return op_key_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* ChunkMeta::release_op_key() {
  // @@protoc_insertion_point(field_release:gs.rpc.ChunkMeta.op_key)
  return op_key_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ChunkMeta::set_allocated_op_key(std::string* op_key) {
  if (op_key != nullptr) {
  ...
  op_key_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), op_key,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:gs.rpc.ChunkMeta.op_key)
}
