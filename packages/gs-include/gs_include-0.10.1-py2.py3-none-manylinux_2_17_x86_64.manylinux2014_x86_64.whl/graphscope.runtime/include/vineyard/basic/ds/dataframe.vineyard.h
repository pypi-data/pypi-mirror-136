#ifndef DS_DATAFRAME_VINEYARD_H
#define DS_DATAFRAME_VINEYARD_H
...
class DataFrameBaseBuilder: public ObjectBuilder {
  public:
    ...
    std::shared_ptr<Object> _Seal(Client &client) override {
        ...
        // using __values__value_type = typename std::map<json, std::shared_ptr<ITensor>>::mapped_type::element_type;
  ...
  protected:
    ...
    std::map<typename std::map<json, std::shared_ptr<ITensor>>::key_type, std::shared_ptr<ObjectBase>> values_;
    ...
    void set_columns_(std::vector<json> const &columns__) {
        this->columns_ = columns__;
    }

    void set_values_(std::map<typename std::map<json, std::shared_ptr<ITensor>>::key_type, std::shared_ptr<ObjectBase>> const &values__) {
        this->values_ = values__;
    }
    void set_values_(typename std::map<json, std::shared_ptr<ITensor>>::key_type const &values__key_,
