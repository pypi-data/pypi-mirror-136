...
class CfnGeofenceCollection(
    ...
    def __init__(
        ...
        *,
        ...
        :param pricing_plan: Specifies the pricing plan for the geofence collection. For additional details and restrictions on each pricing plan option, see the `Amazon Location Service pricing page <https://docs.aws.amazon.com/location/pricing/>`_ .
        ...
        :param pricing_plan_data_source: Specifies the data provider for the geofence collection. - Required value for the following pricing plans: ``MobileAssetTracking`` | ``MobileAssetManagement`` For more information about `Data Providers <https://docs.aws.amazon.com/location/data-providers/>`_ , and `Pricing plans <https://docs.aws.amazon.com/location/pricing/>`_ , see the Amazon Location Service product page. .. epigraph:: Amazon Location Service only uses ``PricingPlanDataSource`` to calculate billing for your geofence collection. Your data will not be shared with the data provider, and will remain in your AWS account or region unless you move it. Valid Values: ``Esri`` | ``Here``
        '''
    ...
    def pricing_plan(self) -> builtins.str:
        ...
        For additional details and restrictions on each pricing plan option, see the `Amazon Location Service pricing page <https://docs.aws.amazon.com/location/pricing/>`_ .
    ...
    def pricing_plan_data_source(self) -> typing.Optional[builtins.str]:
        ...
        For more information about `Data Providers <https://docs.aws.amazon.com/location/data-providers/>`_ , and `Pricing plans <https://docs.aws.amazon.com/location/pricing/>`_ , see the Amazon Location Service product page.
        .. epigraph::
...
class CfnMap(
    ...
    def __init__(
        ...
        *,
        ...
        :param pricing_plan: Specifies the pricing plan for your map resource. For additional details and restrictions on each pricing plan option, see the `Amazon Location Service pricing page <https://docs.aws.amazon.com/location/pricing/>`_ .
...
class CfnPlaceIndex(
    ...
    def __init__(
        ...
        *,
        ...
        :param pricing_plan: Specifies the pricing plan for your place index resource. For additional details and restrictions on each pricing plan option, see the `Amazon Location Service pricing page <https://docs.aws.amazon.com/location/pricing/>`_ .
...
class CfnRouteCalculator(
    ...
    def __init__(
        ...
        *,
        ...
        :param pricing_plan: Specifies the pricing plan for your route calculator resource. For additional details and restrictions on each pricing plan option, see the `Amazon Location Service pricing page <https://docs.aws.amazon.com/location/pricing/>`_ .
...
class CfnTracker(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: - scope in which this resource is defined.
        :param id: - scoped id of the resource.
        :param pricing_plan: Specifies the pricing plan for the tracker resource. For additional details and restrictions on each pricing plan option, see the `Amazon Location Service pricing page <https://docs.aws.amazon.com/location/pricing/>`_ .
