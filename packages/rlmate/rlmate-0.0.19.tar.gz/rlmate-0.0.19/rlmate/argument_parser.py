...
class ArgumentParser(argparse.ArgumentParser):
    ...
    def add_argument_group(
        ...
        **kwargs: t.Any,
        ...
        _add_argument = group.add_argument

        def add_argument_hook(*args, **kwargs):
            argument = _add_argument(*args, **kwargs)
            self._argument_groups[group.title].append(argument)

        group.add_argument = add_argument_hook
