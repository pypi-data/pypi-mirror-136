...
class InlineObject11(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, currency_code, institution_id, title, type, *args, **kwargs):  # noqa: E501
        """InlineObject11 - a model defined in OpenAPI

        Args:
            currency_code (str): A currency code for the account.
            institution_id (int): The ID of the institution to create this account in.
            title (str): A title for the account.
    ...
    @convert_js_args_to_python_args
    def __init__(self, currency_code, institution_id, title, type, *args, **kwargs):  # noqa: E501
        """InlineObject11 - a model defined in OpenAPI
