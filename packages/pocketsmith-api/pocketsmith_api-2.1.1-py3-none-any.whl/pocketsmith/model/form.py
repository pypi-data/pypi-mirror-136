...
def lazy_import():
    ...
    globals()['FormRows'] = FormRows


class Form(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'approximate_expiry_at': (datetime, none_type,),  # noqa: E501
            'encryption': (str,),  # noqa: E501
            'public_key': (str,),  # noqa: E501
            'rows': ([FormRows],),  # noqa: E501
        }
    ...
    attribute_map = {
        'approximate_expiry_at': 'approximate_expiry_at',  # noqa: E501
