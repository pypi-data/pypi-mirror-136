...
class InlineObject14(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, currency_code, title, *args, **kwargs):  # noqa: E501
        """InlineObject14 - a model defined in OpenAPI

        Args:
            currency_code (str): A currency code for the institution.
            title (str): A title for the institution.
    ...
    @convert_js_args_to_python_args
    def __init__(self, currency_code, title, *args, **kwargs):  # noqa: E501
        """InlineObject14 - a model defined in OpenAPI
