...
FILE_URLS = {
    "default": {
        "checkpoint": "https://github.com/thearyadev/SexyThumbnailGenerator/releases/download/FILES/detector_v2_default_checkpoint.onnx",
        "classes": "https://github.com/thearyadev/SexyThumbnailGenerator/releases/download/FILES/classes",
    },
    "base": {
        "checkpoint": "https://github.com/thearyadev/SexyThumbnailGenerator/releases/download/FILES/detector_v2_default_checkpoint.onnx",
        "classes": "https://github.com/thearyadev/SexyThumbnailGenerator/releases/download/FILES/classes",
...
class Detector:
    ...
    def __init__(self, model_name="default"):
        ...
        model_folder = os.path.join(os.path.abspath(__file__.replace("detector.py", "")), f".models/")
