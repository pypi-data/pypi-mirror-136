...
class TestCaseExecutor(threading.Thread):
    ...
    #     logger = logging.getLogger(testcase_full_folder)
    #
    ...
    #     file_handler = logging.FileHandler(logfile_full_name, encoding='utf-8')
    #     formatter = logging.Formatter('%(asctime)s %(levelname)s %(message)s')
    #     file_handler.setFormatter(formatter)
    #     logger.addHandler(file_handler)
    #
    #     not_show_log_in_console = False
    #
    #     if hasattr(settings, "SHOW_LOG_IN_CONSOLE"):
    #         if settings.SHOW_LOG_IN_CONSOLE is False:
    #             not_show_log_in_console = True
    #
    #     if not_show_log_in_console is False:
    ...
    #
    #     # if hasattr(settings, "TESTCASE_LOGGER_LEVEL"):
    #     #     logger.setLevel(settings.TESTCASE_LOGGER_LEVEL)
    #     # else:
