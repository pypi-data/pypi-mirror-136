...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, total_timeout=None, pulp_labels=None, proxy_url=None, pulp_last_updated=None, connect_timeout=None, tls_validation=None, ca_cert=None, pulp_created=None, name=None, pulp_href=None, sock_connect_timeout=None, sock_read_timeout=None, download_concurrency=None, max_retries=None, client_cert=None, rate_limit=None, url=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
