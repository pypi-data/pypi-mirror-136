...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, sock_read_timeout=None, headers=None, name=None, rate_limit=None, pulp_labels=None, client_cert=None, max_retries=None, pulp_last_updated=None, connect_timeout=None, tls_validation=None, pulp_created=None, pulp_href=None, url=None, download_concurrency=None, total_timeout=None, ca_cert=None, sock_connect_timeout=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
