...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, client_cert=None, sock_connect_timeout=None, connect_timeout=None, pulp_labels=None, rate_limit=None, proxy_url=None, download_concurrency=None, url=None, total_timeout=None, name=None, headers=None, pulp_href=None, sock_read_timeout=None, max_retries=None, pulp_created=None, ca_cert=None, pulp_last_updated=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
