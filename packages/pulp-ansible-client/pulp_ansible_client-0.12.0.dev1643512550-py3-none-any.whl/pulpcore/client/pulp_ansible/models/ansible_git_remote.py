...
class AnsibleGitRemote(object):
    ...
    def __init__(self, client_cert=None, proxy_password=None, sock_connect_timeout=None, connect_timeout=None, pulp_labels=None, username=None, password=None, rate_limit=None, proxy_url=None, proxy_username=None, download_concurrency=None, url=None, total_timeout=None, client_key=None, name=None, headers=None, sock_read_timeout=None, max_retries=None, ca_cert=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
