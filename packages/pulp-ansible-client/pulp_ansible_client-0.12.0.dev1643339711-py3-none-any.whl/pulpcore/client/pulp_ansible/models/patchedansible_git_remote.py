...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, connect_timeout=None, tls_validation=None, ca_cert=None, download_concurrency=None, sock_read_timeout=None, proxy_url=None, client_cert=None, total_timeout=None, max_retries=None, headers=None, client_key=None, name=None, username=None, sock_connect_timeout=None, proxy_username=None, proxy_password=None, password=None, url=None, pulp_labels=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
