...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, max_retries=None, pulp_created=None, tls_validation=None, client_cert=None, headers=None, pulp_labels=None, download_concurrency=None, ca_cert=None, pulp_last_updated=None, sock_read_timeout=None, sock_connect_timeout=None, rate_limit=None, proxy_url=None, total_timeout=None, name=None, connect_timeout=None, url=None, pulp_href=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
