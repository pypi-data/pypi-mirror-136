...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, max_retries=None, sock_read_timeout=None, rate_limit=None, name=None, proxy_url=None, headers=None, connect_timeout=None, ca_cert=None, url=None, client_cert=None, tls_validation=None, download_concurrency=None, sock_connect_timeout=None, pulp_href=None, total_timeout=None, pulp_created=None, pulp_labels=None, pulp_last_updated=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
