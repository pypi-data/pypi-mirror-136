...
class AnsibleGitRemote(object):
    ...
    def __init__(self, username=None, max_retries=None, sock_read_timeout=None, rate_limit=None, name=None, proxy_url=None, headers=None, connect_timeout=None, password=None, ca_cert=None, url=None, proxy_password=None, client_cert=None, tls_validation=None, download_concurrency=None, proxy_username=None, sock_connect_timeout=None, total_timeout=None, client_key=None, pulp_labels=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
