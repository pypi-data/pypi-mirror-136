...
class AnsibleGitRemote(object):
    ...
    def __init__(self, headers=None, proxy_url=None, name=None, max_retries=None, tls_validation=None, sock_read_timeout=None, password=None, username=None, proxy_username=None, pulp_labels=None, rate_limit=None, download_concurrency=None, proxy_password=None, connect_timeout=None, client_key=None, sock_connect_timeout=None, total_timeout=None, ca_cert=None, url=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
