...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_username=None, client_key=None, password=None, max_retries=None, tls_validation=None, client_cert=None, headers=None, proxy_password=None, pulp_labels=None, download_concurrency=None, ca_cert=None, sock_read_timeout=None, sock_connect_timeout=None, rate_limit=None, proxy_url=None, total_timeout=None, name=None, connect_timeout=None, username=None, url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
