...
class AnsibleGitRemote(object):
    ...
    def __init__(self, proxy_username=None, sock_read_timeout=None, username=None, headers=None, name=None, proxy_password=None, rate_limit=None, pulp_labels=None, password=None, client_cert=None, client_key=None, max_retries=None, connect_timeout=None, tls_validation=None, url=None, download_concurrency=None, total_timeout=None, ca_cert=None, sock_connect_timeout=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
