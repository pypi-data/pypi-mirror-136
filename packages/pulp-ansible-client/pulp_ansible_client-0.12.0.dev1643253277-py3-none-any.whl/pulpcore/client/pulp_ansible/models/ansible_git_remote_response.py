...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, pulp_href=None, name=None, tls_validation=None, connect_timeout=None, sock_read_timeout=None, headers=None, url=None, rate_limit=None, pulp_created=None, max_retries=None, ca_cert=None, proxy_url=None, sock_connect_timeout=None, pulp_labels=None, total_timeout=None, download_concurrency=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
