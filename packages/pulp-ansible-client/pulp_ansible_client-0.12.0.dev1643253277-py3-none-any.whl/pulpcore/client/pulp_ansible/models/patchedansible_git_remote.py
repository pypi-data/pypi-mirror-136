...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_username=None, name=None, tls_validation=None, connect_timeout=None, sock_read_timeout=None, headers=None, username=None, password=None, url=None, rate_limit=None, proxy_password=None, max_retries=None, ca_cert=None, proxy_url=None, sock_connect_timeout=None, client_key=None, pulp_labels=None, total_timeout=None, download_concurrency=None, client_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
