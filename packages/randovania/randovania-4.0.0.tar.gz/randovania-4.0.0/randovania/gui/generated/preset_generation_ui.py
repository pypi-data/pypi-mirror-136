...
class Ui_PresetGeneration(object):
    def setupUi(self, PresetGeneration):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 471, 733))
        self.verticalLayout_3 = QVBoxLayout(self.scrollAreaWidgetContents)
        self.verticalLayout_3.setSpacing(6)
        self.verticalLayout_3.setContentsMargins(11, 11, 11, 11)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.game_specific_group = QGroupBox(self.scrollAreaWidgetContents)
        ...
        self.randomization_mode_group = QGroupBox(self.scrollAreaWidgetContents)
        ...
        self.logic_group = QGroupBox(self.scrollAreaWidgetContents)
        ...
        self.damage_strictness_group = QGroupBox(self.scrollAreaWidgetContents)
