"""
Open Generation and Transmission Operation and Expansion Planning Model with RES and ESS (openTEPES) - January 27, 2022
"""
...
def openTEPES_run(DirName, CaseName, SolverName, pIndLogConsole):
    ...
    #%% model declaration
    mTEPES = ConcreteModel('Open Generation and Transmission Operation and Expansion Planning Model with RES and ESS (openTEPES) - Version 4.3.4 - January 27, 2022')
