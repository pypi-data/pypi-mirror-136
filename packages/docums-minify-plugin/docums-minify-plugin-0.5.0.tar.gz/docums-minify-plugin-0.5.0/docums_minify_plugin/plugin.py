...
class MinifyPlugin(BasePlugin):
    ...
    config_scheme = (
        ('minify_html', docums.config.config_options.Type(bool, default=False)),
        ('minify_js', docums.config.config_options.Type(bool, default=False)),
        ('minify_css', docums.config.config_options.Type(bool, default=False)),
        ('js_files', docums.config.config_options.Type((str, list), default=None)),
        ('css_files', docums.config.config_options.Type((str, list), default=None)),
        ('htmlmin_opts', docums.config.config_options.Type((str, dict), default=None)),
    )
