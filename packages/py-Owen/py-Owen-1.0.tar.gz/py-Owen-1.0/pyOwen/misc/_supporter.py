...
from pyOwen.misc._decorators import Owen_cmd
from pyOwen.misc._wrappers import eod, eor

from .. import *
from ..dB._core import LIST
from . import CMD_HELP, SUDO_M  # ignore: pylint

ALIVE_NAME = owen_bot.me.first_name
BOTLOG_CHATID = BOTLOG = udB.get_key("LOG_CHANNEL")


bot = borg = friday = owen_bot
...
class Config((object)):
    if ENV:
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Owen")
