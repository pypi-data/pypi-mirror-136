...
class OwenClient(TelegramClient):
    def __init__(
        self,
        session,
        api_id=None,
    ...
    async def fast_uploader(self, file, **kwargs):
        ...
        from pyOwen.functions.FastTelethon import upload_file
        from pyOwen.functions.helper import progress
    ...
    async def fast_downloader(self, file, filename, **kwargs):
        ...
        from pyOwen.functions.FastTelethon import download_file
        from pyOwen.functions.helper import progress
