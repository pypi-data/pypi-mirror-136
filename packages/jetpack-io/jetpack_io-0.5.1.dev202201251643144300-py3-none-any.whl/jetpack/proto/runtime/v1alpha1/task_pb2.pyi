...
import jetpack.proto.runtime.v1alpha1.runtime_pb2
import typing
...
class PersistedTask(google.protobuf.message.Message):
    ...
    @property
    def result(self) -> jetpack.proto.runtime.v1alpha1.runtime_pb2.Result: ...
    ...
    def __init__(self,
        *,
        ...
        manifest : builtins.bytes = ...,
        status : global___PersistedTask.Status.V = ...,
        result : typing.Optional[jetpack.proto.runtime.v1alpha1.runtime_pb2.Result] = ...,
        app_name : typing.Text = ...,
        ) -> None: ...
