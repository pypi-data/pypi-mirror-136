...
class Task(google.protobuf.message.Message):
    ...
    # name of the app that started this task
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"app_name",b"app_name",u"encoded_args",b"encoded_args",u"hostname",b"hostname",u"namespace",b"namespace",u"qualified_symbol",b"qualified_symbol",u"target_time",b"target_time",u"task_id",b"task_id"]) -> None: ...
global___Task = Task
