...
def encode_result(result: Any) -> runtime_pb2.RemoteCallResponse:
    response = runtime_pb2.RemoteCallResponse()
    response.json_results = jsonpickle.encode(result)
    return response


def decode_result(response: runtime_pb2.RemoteCallResponse) -> Any:
