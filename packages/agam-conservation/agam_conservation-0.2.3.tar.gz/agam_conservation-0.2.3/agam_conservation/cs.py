...
class ConservationScore:
    ...
    def download(self, file_name=os.path.join(DATA_PATH, 'AgamP4_conservation.h5')):
    ...
    def plot(self, region_str, array='Cs', include_arrays=['Cs'], save_to=None):
        ...
        geneset_agam = allel.FeatureTable.from_gff3(os.path.join(DATA_PATH, 'AgamP4.12.gff3'),
