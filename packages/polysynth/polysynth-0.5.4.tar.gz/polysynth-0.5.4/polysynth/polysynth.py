...
class Polysynth:
    ...
    def cancel_transaction(self, tx_hash: Optional[str]=None) -> Any:
        try:
            ...
            return TransactionFailedError(StatusCode.FAILED_TRANSACTION.value, StatusCode.TRANSACTION_NOT_CANCELLED.value, str(e).replace("\\", r"\\")).__dict__()
    ...
    def retry_transaction(self, tx_hash: str) -> Any:
        try:
            ...
            return TransactionFailedError(StatusCode.FAILED_TRANSACTION.value, StatusCode.RETRY_FAILED.value, str(e).replace("\\", r"\\")).__dict__()
