...
class TestUtils(unittest.TestCase):
    ...
    def test_send_message(self):
        ...
        self.assertIsInstance(test_socket.received_message, bytes)
        #проверка на отсутствие ACTION
        self.assertNotEqual(test_socket.test_dict, {TIME: 111111.111111, USER: {ACCOUNT_NAME: 'test_test'}})
        # проверка на другое значение ACTION
        self.assertNotEqual(test_socket.test_dict, {ACTION: 'hello', TIME: 111111.111111, USER: {ACCOUNT_NAME: 'test_test'}})
    ...
    def test_get_message(self):
        ...
        # проверяем разницу между правильным и не правильным словарем
        self.assertNotEqual(get_message(test_sock_err), self.test_dict_recv_ok)
        # проверяем тип данных
        self.assertIsInstance(get_message(test_sock_ok), dict)
        # сверяем словари
        self.assertDictEqual(get_message(test_sock_ok), self.test_dict_recv_ok)
